.class public Lorg/telegram/ui/Cells/SecurityCell;
.super Lorg/telegram/ui/Cells/BaseCell;
.source "SecurityCell.java"


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;
    }
.end annotation
...
.field private customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarImage:Lorg/telegram/messenger/ImageReceiver;

    new-instance v0, Lorg/telegram/ui/Components/AvatarDrawable;

    invoke-direct {v0}, Lorg/telegram/ui/Components/AvatarDrawable;-><init>()V

    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarDrawable:Lorg/telegram/ui/Components/AvatarDrawable;

    iput-object v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;

    iput-object v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;

    iput-object v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;

    iput-object v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastPrintString:Ljava/lang/CharSequence;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->useSeparator:Z
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->timeTop:I
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawTop:I
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->messageTop:I

    invoke-static {v2}, Lorg/telegram/messenger/AndroidUtilities;->dp(F)I

    move-result v0

    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->errorTop:I

    invoke-static {v2}, Lorg/telegram/messenger/AndroidUtilities;->dp(F)I

    move-result v0

    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->pinTop:I

    invoke-static {v2}, Lorg/telegram/messenger/AndroidUtilities;->dp(F)I

    move-result v0

    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->countTop:I
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarTop:I

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->rect:Landroid/graphics/RectF;

    invoke-static {p1}, Lorg/telegram/ui/ActionBar/Theme;->createDialogsResources(Landroid/content/Context;)V

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarImage:Lorg/telegram/messenger/ImageReceiver;
...
.method private getDialogsArray()Ljava/util/ArrayList;
    ...
    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->dialogsType:I
...
.method public buildLayout()V
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->isSecurityCell:Z
    ...
    iget-wide v12, v0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J
    ...
    iput-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z

    const/4 v6, 0x0

    move-object/from16 v0, p0

    iput-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBroadcast:Z

    const/4 v6, 0x0

    move-object/from16 v0, p0

    iput-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameLock:Z

    const/4 v6, 0x0

    move-object/from16 v0, p0

    iput-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBot:Z

    const/4 v6, 0x0

    move-object/from16 v0, p0

    iput-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawVerified:Z

    move-object/from16 v0, p0

    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    if-eqz v6, :cond_17

    move-object/from16 v0, p0

    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v2, v2, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->type:I
    ...
    iput-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameLock:Z
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockTop:I
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockLeft:I
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I
    ...
    iget-boolean v2, v2, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->isMedia:Z
    ...
    iget-object v10, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget v6, v6, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->date:I
    ...
    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v7, v7, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->unread_count:I
    ...
    iput-boolean v5, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCount:Z
    ...
    iget-object v10, v0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v10, v10, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->unread_count:I
    ...
    iget-boolean v7, v7, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->sent:Z
    ...
    iput-boolean v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck1:Z

    const/4 v7, 0x1

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck2:Z

    const/4 v7, 0x0

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawClock:Z

    const/4 v7, 0x0

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawError:Z
    ...
    iget-object v8, v7, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->name:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v7, v7, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->type:I
    ...
    iput-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->timeLayout:Landroid/text/StaticLayout;

    sget-boolean v2, Lorg/telegram/messenger/LocaleController;->isRTL:Z

    if-nez v2, :cond_58

    invoke-virtual/range {p0 .. p0}, Lorg/telegram/ui/Cells/SecurityCell;->getMeasuredWidth()I
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->timeLeft:I
    ...
    iget v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameLock:Z
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawClock:Z
    ...
    iget v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->timeLeft:I

    sub-int v3, v4, v3

    move-object/from16 v0, p0

    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawLeft:I

    :cond_3
    :goto_9
    move-object/from16 v0, p0

    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->dialogMuted:Z

    if-eqz v3, :cond_62

    move-object/from16 v0, p0

    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawVerified:Z
    ...
    iget v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I

    add-int/2addr v3, v4

    move-object/from16 v0, p0

    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I
    ...
    iput-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLayout:Landroid/text/StaticLayout;
    :try_end_0
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLeft:I
    ...
    iget-object v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->avatarImage:Lorg/telegram/messenger/ImageReceiver;

    move-object/from16 v0, p0

    iget v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->avatarTop:I
    ...
    iget-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawError:Z
    ...
    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->errorLeft:I
    ...
    iput-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLayout:Landroid/text/StaticLayout;
    :try_end_1
    ...
    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLayout:Landroid/text/StaticLayout;
    ...
    iget-object v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLayout:Landroid/text/StaticLayout;
    ...
    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameMuteLeft:I
    ...
    iget v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I
    ...
    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLayout:Landroid/text/StaticLayout;
    ...
    iget v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLeft:I
    ...
    iget-boolean v2, v2, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->verified:Z

    move-object/from16 v0, p0

    iput-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawVerified:Z
    ...
    iput-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z
    ...
    iget-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z
    ...
    iget-object v2, v2, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->message:Ljava/lang/String;
    ...
    iget-boolean v6, v6, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->isMedia:Z
    ...
    iput-boolean v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCount:Z
    ...
    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;
    ...
    iput v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockTop:I
    ...
    iput v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockLeft:I
    ...
    iput v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I

    :cond_18
    :goto_15
    move-object/from16 v0, p0

    iget v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->lastMessageDate:I

    move-object/from16 v0, p0

    iget v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->lastMessageDate:I

    if-nez v11, :cond_19

    move-object/from16 v0, p0

    iget-object v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;

    if-eqz v11, :cond_19

    move-object/from16 v0, p0

    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget-boolean v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->isSecurityCell:Z
    ...
    iput-object v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;

    move-object/from16 v0, p0

    iget-object v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;
    ...
    iget v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    iput-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;
    ...
    iput-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->lastPrintString:Ljava/lang/CharSequence;
    ...
    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;
    ...
    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    iget-boolean v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z
    ...
    iget-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;
    ...
    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;

    if-nez v2, :cond_37

    move-object/from16 v0, p0

    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;
    ...
    iget-object v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v12, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget-object v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget-object v12, v0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    iget v11, v0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;
    ...
    iget-object v7, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v8, v0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;
    ...
    iget-object v8, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v10, v0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBroadcast:Z
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBot:Z
    ...
    iput v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawLeft:I
    ...
    iget-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck2:Z
    ...
    iget-boolean v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck1:Z
    ...
    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->halfCheckDrawLeft:I

    move-object/from16 v0, p0

    iget v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->halfCheckDrawLeft:I
    ...
    iget v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawLeft:I
    ...
    iput v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->halfCheckDrawLeft:I
    ...
    iget v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLeft:I

    add-int/2addr v3, v4

    move-object/from16 v0, p0

    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->messageLeft:I
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->countWidth:I
    ...
    iget v9, v0, Lorg/telegram/ui/Cells/SecurityCell;->countWidth:I
    ...
    iput-object v6, v0, Lorg/telegram/ui/Cells/SecurityCell;->countLayout:Landroid/text/StaticLayout;

    move-object/from16 v0, p0

    iget v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->countWidth:I
    ...
    iget v4, v0, Lorg/telegram/ui/Cells/SecurityCell;->countWidth:I
    ...
    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->countLeft:I
    ...
    iput-boolean v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawCount:Z
    ...
    iget-boolean v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->drawPin:Z
    ...
    iput v3, v0, Lorg/telegram/ui/Cells/SecurityCell;->pinLeft:I
    ...
    iput v2, v0, Lorg/telegram/ui/Cells/SecurityCell;->nameMuteLeft:I
...
.method public checkCurrentDialogIndex()V
    ...
    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->index:I

    invoke-direct {p0}, Lorg/telegram/ui/Cells/SecurityCell;->getDialogsArray()Ljava/util/ArrayList;
    ...
    iget v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->index:I
    ...
    iget-wide v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J
    ...
    iget-wide v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J
    ...
    iget-object v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentEditDate:I

    if-ne v3, v4, :cond_3

    :cond_1
    iget v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    :cond_2
    iget-object v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->draftMessage:Lorg/telegram/tgnet/TLRPC$DraftMessage;

    if-ne v2, v1, :cond_3

    iget-boolean v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawPin:Z
    ...
    iput-wide v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lorg/telegram/ui/Cells/SecurityCell;->update(I)V
...
.method public getDialogId()J
    ...
    iget-wide v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;
    ...
    :cond_0
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->isSelected:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lorg/telegram/ui/Cells/SecurityCell;->getMeasuredWidth()I

    move-result v0

    int-to-float v3, v0

    invoke-virtual {p0}, Lorg/telegram/ui/Cells/SecurityCell;->getMeasuredHeight()I
    ...
    :cond_1
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawPin:Z
    ...
    :cond_2
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameLock:Z

    if-eqz v0, :cond_a

    sget-object v0, Lorg/telegram/ui/ActionBar/Theme;->dialogs_lockDrawable:Landroid/graphics/drawable/Drawable;

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockLeft:I

    iget v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->nameLockTop:I

    invoke-virtual {p0, v0, v2, v3}, Lorg/telegram/ui/Cells/SecurityCell;->setDrawableBounds(Landroid/graphics/drawable/Drawable;II)V
    ...
    :cond_3
    :goto_1
    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->nameLayout:Landroid/text/StaticLayout;

    if-eqz v0, :cond_4

    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->nameLeft:I
    ...
    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->timeLeft:I

    int-to-float v0, v0

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->timeTop:I

    int-to-float v2, v2

    invoke-virtual {p1, v0, v2}, Landroid/graphics/Canvas;->translate(FF)V

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->timeLayout:Landroid/text/StaticLayout;

    invoke-virtual {v0, p1}, Landroid/text/StaticLayout;->draw(Landroid/graphics/Canvas;)V

    invoke-virtual {p1}, Landroid/graphics/Canvas;->restore()V

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->messageLayout:Landroid/text/StaticLayout;

    if-eqz v0, :cond_5

    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->messageLeft:I

    int-to-float v0, v0

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->messageTop:I
    ...
    :cond_5
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawClock:Z

    if-eqz v0, :cond_d

    sget-object v0, Lorg/telegram/ui/ActionBar/Theme;->dialogs_clockDrawable:Landroid/graphics/drawable/Drawable;

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawLeft:I

    iget v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->checkDrawTop:I
    ...
    :cond_6
    :goto_3
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->dialogMuted:Z

    if-eqz v0, :cond_f

    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawVerified:Z

    if-nez v0, :cond_f

    sget-object v0, Lorg/telegram/ui/ActionBar/Theme;->dialogs_muteDrawable:Landroid/graphics/drawable/Drawable;

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->nameMuteLeft:I
    ...
    :cond_7
    :goto_4
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawError:Z

    if-eqz v0, :cond_10

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->rect:Landroid/graphics/RectF;

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->errorLeft:I

    int-to-float v2, v2

    iget v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->errorTop:I

    int-to-float v3, v3

    iget v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->errorLeft:I
    ...
    iget v5, p0, Lorg/telegram/ui/Cells/SecurityCell;->errorTop:I
    ...
    :cond_8
    :goto_5
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->useSeparator:Z
    ...
    :cond_a
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameGroup:Z
    ...
    :cond_b
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBroadcast:Z
    ...
    :cond_c
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawNameBot:Z
    ...
    :cond_d
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck2:Z

    if-eqz v0, :cond_6

    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawCheck1:Z

    if-eqz v0, :cond_e

    sget-object v0, Lorg/telegram/ui/ActionBar/Theme;->dialogs_halfCheckDrawable:Landroid/graphics/drawable/Drawable;

    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->halfCheckDrawLeft:I
    ...
    :cond_10
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawCount:Z

    if-eqz v0, :cond_13

    iget v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->countLeft:I
    ...
    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->rect:Landroid/graphics/RectF;

    int-to-float v3, v0

    iget v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->countTop:I

    int-to-float v4, v4

    iget v5, p0, Lorg/telegram/ui/Cells/SecurityCell;->countWidth:I
    ...
    iget v5, p0, Lorg/telegram/ui/Cells/SecurityCell;->countTop:I
    ...
    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->countTop:I
    ...
    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->countLayout:Landroid/text/StaticLayout;
    ...
    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->pinLeft:I

    iget v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->pinTop:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p0}, Lorg/telegram/ui/Cells/SecurityCell;->buildLayout()V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, v1, v0}, Lorg/telegram/ui/Cells/SecurityCell;->setMeasuredDimension(II)V
...
.method public setDialog(JLorg/telegram/messenger/MessageObject;I)V
    ...
    iput-wide p1, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J

    iput-object p3, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;

    iput-boolean v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->isSecurityCell:Z

    iput p4, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastMessageDate:I
    ...
    :goto_0
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentEditDate:I

    iput v1, p0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    :goto_1
    iput-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastUnreadState:Z

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastSendState:I

    :cond_0
    invoke-virtual {p0, v1}, Lorg/telegram/ui/Cells/SecurityCell;->update(I)V
...
.method public setDialog(Lorg/telegram/tgnet/TLRPC$TL_dialog;II)V
    ...
    iput-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->isSecurityCell:Z

    iput p2, p0, Lorg/telegram/ui/Cells/SecurityCell;->index:I

    iput p3, p0, Lorg/telegram/ui/Cells/SecurityCell;->dialogsType:I
...
.method public setDialog(Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;)V
    .locals 1

    iput-object p1, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;
...
.method public setDialogSelected(Z)V
    ...
    invoke-virtual {p0}, Lorg/telegram/ui/Cells/SecurityCell;->invalidate()V

    :cond_0
    iput-boolean p1, p0, Lorg/telegram/ui/Cells/SecurityCell;->isSelected:Z
...
.method public update(I)V
    ...
    iget v0, v0, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->date:I

    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastMessageDate:I

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v0, v0, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->unread_count:I
    ...
    iput v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget-boolean v0, v0, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->pinned:Z

    iput-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawPin:Z

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget-boolean v0, v0, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->muted:Z

    iput-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->dialogMuted:Z

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarDrawable:Lorg/telegram/ui/Components/AvatarDrawable;

    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget v2, v2, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->id:I

    iget-object v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->customDialog:Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;

    iget-object v3, v3, Lorg/telegram/ui/Cells/SecurityCell$CustomDialog;->name:Ljava/lang/String;
    ...
    iget-object v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarDrawable:Lorg/telegram/ui/Components/AvatarDrawable;
    ...
    :cond_3
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->isSecurityCell:Z
    ...
    iget-wide v6, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentDialogId:J
    ...
    iput-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;

    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    :goto_3
    iput-boolean v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastUnreadState:Z

    iget v2, v0, Lorg/telegram/tgnet/TLRPC$TL_dialog;->unread_count:I

    iput v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    :goto_4
    iput v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->currentEditDate:I

    iget v2, v0, Lorg/telegram/tgnet/TLRPC$TL_dialog;->last_message_date:I

    iput v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastMessageDate:I
    ...
    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastPrintString:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-boolean v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastUnreadState:Z

    iget-object v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->message:Lorg/telegram/messenger/MessageObject;
    ...
    iget v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->lastSendState:I
    ...
    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    :goto_a
    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarDrawable:Lorg/telegram/ui/Components/AvatarDrawable;

    iget-object v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    :goto_b
    iget-object v6, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarImage:Lorg/telegram/messenger/ImageReceiver;

    const-string/jumbo v8, "50_50"

    iget-object v9, p0, Lorg/telegram/ui/Cells/SecurityCell;->avatarDrawable:Lorg/telegram/ui/Components/AvatarDrawable;
    ...
    :cond_11
    iput-boolean v5, p0, Lorg/telegram/ui/Cells/SecurityCell;->drawPin:Z
    ...
    iget v4, p0, Lorg/telegram/ui/Cells/SecurityCell;->unreadCount:I
    ...
    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->user:Lorg/telegram/tgnet/TLRPC$User;
    ...
    iput-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;

    iget-object v0, p0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;
    ...
    iget-object v2, p0, Lorg/telegram/ui/Cells/SecurityCell;->encryptedChat:Lorg/telegram/tgnet/TLRPC$EncryptedChat;
    ...
    iget-object v3, p0, Lorg/telegram/ui/Cells/SecurityCell;->chat:Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    :cond_18
    invoke-virtual {p0}, Lorg/telegram/ui/Cells/SecurityCell;->requestLayout()V
