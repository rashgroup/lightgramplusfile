...
.method private getVersionLine(ILorg/json/JSONObject;)Ljava/lang/String;
    ...
    iget v1, p0, Lnet/hockeyapp/android/utils/VersionHelper;->mCurrentVersionCode:I
...
.method private getVersionNotes(ILorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {p2, v1, v2}, Lnet/hockeyapp/android/utils/VersionHelper;->failSafeGetStringFromJSON(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private loadVersions(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    iput-object v7, p0, Lnet/hockeyapp/android/utils/VersionHelper;->mNewest:Lorg/json/JSONObject;
...
.method public getFileSizeBytes()J
    ...
    invoke-static {v0, v1, v4, v5}, Lnet/hockeyapp/android/utils/VersionHelper;->failSafeGetLongFromJSON(Lorg/json/JSONObject;Ljava/lang/String;J)J
...
.method public getReleaseNotes(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0}, Lnet/hockeyapp/android/utils/VersionHelper;->getRestoreButton(ILorg/json/JSONObject;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, v1, v0}, Lnet/hockeyapp/android/utils/VersionHelper;->getVersionLine(ILorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-direct {p0, v1, v0}, Lnet/hockeyapp/android/utils/VersionHelper;->getVersionNotes(ILorg/json/JSONObject;)Ljava/lang/String;
