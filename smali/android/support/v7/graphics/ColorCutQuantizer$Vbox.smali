...
.method final findSplitPoint()I
    ...
    invoke-static {v2, v0, v1, v4}, Landroid/support/v7/graphics/ColorCutQuantizer;->modifySignificantOctet([IIII)V
...
.method final fitBox()V
    ...
    invoke-static {v8}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedRed(I)I

    move-result v10

    invoke-static {v8}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedGreen(I)I

    move-result v9

    invoke-static {v8}, Landroid/support/v7/graphics/ColorCutQuantizer;->quantizedBlue(I)I
...
.method final getAverageColor()Landroid/support/v7/graphics/Palette$Swatch;
    ...
    invoke-static {v0, v3, v2}, Landroid/support/v7/graphics/ColorCutQuantizer;->approximateToRgb888(III)I
