...
.method public static TLdeserialize(Lorg/telegram/tgnet/AbstractSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$TL_webDocument;
    ...
    const-string/jumbo v1, "can\'t parse magic %x in TL_webDocument"
...
.method public readParams(Lorg/telegram/tgnet/AbstractSerializedData;Z)V
    ...
    iput-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->url:Ljava/lang/String;

    invoke-virtual {p1, p2}, Lorg/telegram/tgnet/AbstractSerializedData;->readInt64(Z)J

    move-result-wide v2

    iput-wide v2, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->access_hash:J

    invoke-virtual {p1, p2}, Lorg/telegram/tgnet/AbstractSerializedData;->readInt32(Z)I

    move-result v1

    iput v1, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->size:I

    invoke-virtual {p1, p2}, Lorg/telegram/tgnet/AbstractSerializedData;->readString(Z)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->mime_type:Ljava/lang/String;
    ...
    :cond_2
    iget-object v3, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->attributes:Ljava/util/ArrayList;
    ...
    iput v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->dc_id:I
...
.method public serializeToStream(Lorg/telegram/tgnet/AbstractSerializedData;)V
    ...
    iget-object v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->url:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lorg/telegram/tgnet/AbstractSerializedData;->writeString(Ljava/lang/String;)V

    iget-wide v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->access_hash:J

    invoke-virtual {p1, v0, v1}, Lorg/telegram/tgnet/AbstractSerializedData;->writeInt64(J)V

    iget v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->size:I
    ...
    iget-object v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->attributes:Ljava/util/ArrayList;
    ...
    :cond_0
    iget v0, p0, Lorg/telegram/tgnet/TLRPC$TL_webDocument;->dc_id:I
