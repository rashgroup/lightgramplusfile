...
.method static getTimeZoneDisplay(Ljava/util/TimeZone;ZILjava/util/Locale;)Ljava/lang/String;
    ...
    new-instance v2, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneDisplayKey;

    invoke-direct {v2, p0, p1, p2, p3}, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneDisplayKey;-><init>(Ljava/util/TimeZone;ZILjava/util/Locale;)V

    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter;->cTimeZoneDisplayCache:Ljava/util/concurrent/ConcurrentMap;
...
.method protected applyRules(Ljava/util/Calendar;Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
    ...
    iget-object v1, p0, Lorg/telegram/messenger/time/FastDatePrinter;->mRules:[Lorg/telegram/messenger/time/FastDatePrinter$Rule;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Lorg/telegram/messenger/time/FastDatePrinter;
    ...
    iget-object v2, p1, Lorg/telegram/messenger/time/FastDatePrinter;->mLocale:Ljava/util/Locale;
...
.method public format(J)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lorg/telegram/ui/tools/a/d;->e()Ljava/lang/String;
...
.method public format(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lorg/telegram/ui/tools/a/d;->d()Ljava/lang/String;
...
.method protected parsePattern()Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v10}, Lorg/telegram/messenger/time/FastDatePrinter;->parseToken(Ljava/lang/String;[I)Ljava/lang/String;
    ...
    :sswitch_0
    new-instance v0, Lorg/telegram/messenger/time/FastDatePrinter$TextField;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v5}, Lorg/telegram/messenger/time/FastDatePrinter$TextField;-><init>(I[Ljava/lang/String;)V
    ...
    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter$TwoDigitYearField;->INSTANCE:Lorg/telegram/messenger/time/FastDatePrinter$TwoDigitYearField;
    ...
    :cond_3
    invoke-virtual {p0, v3, v0}, Lorg/telegram/messenger/time/FastDatePrinter;->selectNumberRule(II)Lorg/telegram/messenger/time/FastDatePrinter$NumberRule;
    ...
    invoke-direct {v0, v3, v6}, Lorg/telegram/messenger/time/FastDatePrinter$TextField;-><init>(I[Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3, v7}, Lorg/telegram/messenger/time/FastDatePrinter$TextField;-><init>(I[Ljava/lang/String;)V
    ...
    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter$TwoDigitMonthField;->INSTANCE:Lorg/telegram/messenger/time/FastDatePrinter$TwoDigitMonthField;

    goto :goto_1

    :cond_6
    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter$UnpaddedMonthField;->INSTANCE:Lorg/telegram/messenger/time/FastDatePrinter$UnpaddedMonthField;
    ...
    :sswitch_4
    new-instance v3, Lorg/telegram/messenger/time/FastDatePrinter$TwelveHourField;

    const/16 v12, 0xa

    invoke-virtual {p0, v12, v0}, Lorg/telegram/messenger/time/FastDatePrinter;->selectNumberRule(II)Lorg/telegram/messenger/time/FastDatePrinter$NumberRule;

    move-result-object v0

    invoke-direct {v3, v0}, Lorg/telegram/messenger/time/FastDatePrinter$TwelveHourField;-><init>(Lorg/telegram/messenger/time/FastDatePrinter$NumberRule;)V
    ...
    :sswitch_9
    new-instance v3, Lorg/telegram/messenger/time/FastDatePrinter$TextField;
    ...
    :goto_2
    invoke-direct {v3, v12, v0}, Lorg/telegram/messenger/time/FastDatePrinter$TextField;-><init>(I[Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3, v8}, Lorg/telegram/messenger/time/FastDatePrinter$TextField;-><init>(I[Ljava/lang/String;)V

    goto/16 :goto_1

    :sswitch_f
    new-instance v3, Lorg/telegram/messenger/time/FastDatePrinter$TwentyFourHourField;
    ...
    invoke-direct {v3, v0}, Lorg/telegram/messenger/time/FastDatePrinter$TwentyFourHourField;-><init>(Lorg/telegram/messenger/time/FastDatePrinter$NumberRule;)V
    ...
    new-instance v0, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNameRule;

    iget-object v3, p0, Lorg/telegram/messenger/time/FastDatePrinter;->mTimeZone:Ljava/util/TimeZone;

    iget-object v12, p0, Lorg/telegram/messenger/time/FastDatePrinter;->mLocale:Ljava/util/Locale;

    const/4 v13, 0x1

    invoke-direct {v0, v3, v12, v13}, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNameRule;-><init>(Ljava/util/TimeZone;Ljava/util/Locale;I)V
    ...
    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNumberRule;->INSTANCE_NO_COLON:Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNumberRule;

    goto/16 :goto_1

    :cond_9
    sget-object v0, Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNumberRule;->INSTANCE_COLON:Lorg/telegram/messenger/time/FastDatePrinter$TimeZoneNumberRule;
    ...
    new-instance v0, Lorg/telegram/messenger/time/FastDatePrinter$CharacterLiteral;
    ...
    invoke-direct {v0, v3}, Lorg/telegram/messenger/time/FastDatePrinter$CharacterLiteral;-><init>(C)V

    goto/16 :goto_1

    :cond_a
    new-instance v0, Lorg/telegram/messenger/time/FastDatePrinter$StringLiteral;

    invoke-direct {v0, v3}, Lorg/telegram/messenger/time/FastDatePrinter$StringLiteral;-><init>(Ljava/lang/String;)V
