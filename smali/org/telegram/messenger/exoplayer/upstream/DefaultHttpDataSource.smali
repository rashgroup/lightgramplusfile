...
.method private closeConnectionQuietly()V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
...
.method private static getContentLength(Ljava/net/HttpURLConnection;)J
    ...
    sget-object v2, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->CONTENT_RANGE_HEADER:Ljava/util/regex/Pattern;
...
.method private makeConnection(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->connectTimeoutMillis:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setConnectTimeout(I)V

    iget v1, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->readTimeoutMillis:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setReadTimeout(I)V

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->requestProperties:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->userAgent:Ljava/lang/String;
...
.method private makeConnection(Lorg/telegram/messenger/exoplayer/upstream/DataSpec;)Ljava/net/HttpURLConnection;
    ...
    iget-object v3, p1, Lorg/telegram/messenger/exoplayer/upstream/DataSpec;->postBody:[B
    ...
    :goto_0
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->allowCrossProtocolRedirects:Z

    if-nez v1, :cond_1

    move-object v1, p0

    invoke-direct/range {v1 .. v9}, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->makeConnection(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v2, v9}, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->handleRedirect(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
...
.method private readInternal([BII)I
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->listener:Lorg/telegram/messenger/exoplayer/upstream/TransferListener;
...
.method private skipInternal()V
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesToSkip:J
    ...
    :cond_0
    sget-object v0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->skipBufferReference:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    :goto_1
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    invoke-interface {v2, v1}, Lorg/telegram/messenger/exoplayer/upstream/TransferListener;->onBytesTransferred(I)V

    goto :goto_1

    :cond_4
    sget-object v1, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->skipBufferReference:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public close()V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->inputStream:Ljava/io/InputStream;
    ...
    invoke-static {v0, v2, v3}, Lorg/telegram/messenger/exoplayer/util/Util;->maybeTerminateInputStream(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->opened:Z
...
.method public open(Lorg/telegram/messenger/exoplayer/upstream/DataSpec;)J
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesRead:J

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    iput-object v4, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
    ...
    new-instance v1, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$InvalidResponseCodeException;

    invoke-direct {v1, v4, v0, p1}, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$InvalidResponseCodeException;-><init>(ILjava/util/Map;Lorg/telegram/messenger/exoplayer/upstream/DataSpec;)V
    ...
    invoke-direct {v1, v2, v0, p1, v7}, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/lang/String;Ljava/io/IOException;Lorg/telegram/messenger/exoplayer/upstream/DataSpec;I)V
    ...
    :cond_1
    iget-object v5, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;

    invoke-virtual {v5}, Ljava/net/HttpURLConnection;->getContentType()Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->contentTypePredicate:Lorg/telegram/messenger/exoplayer/util/Predicate;

    if-eqz v6, :cond_2

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->contentTypePredicate:Lorg/telegram/messenger/exoplayer/util/Predicate;

    invoke-interface {v6, v5}, Lorg/telegram/messenger/exoplayer/util/Predicate;->evaluate(Ljava/lang/Object;)Z
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$InvalidContentTypeException;

    invoke-direct {v0, v5, p1}, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$InvalidContentTypeException;-><init>(Ljava/lang/String;Lorg/telegram/messenger/exoplayer/upstream/DataSpec;)V
    ...
    :cond_3
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesToSkip:J
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->getContentLength(Ljava/net/HttpURLConnection;)J
    ...
    :goto_0
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->bytesToRead:J
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->inputStream:Ljava/io/InputStream;
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_2

    iput-boolean v7, p0, Lorg/telegram/messenger/exoplayer/upstream/DefaultHttpDataSource;->opened:Z
    ...
    invoke-direct {v1, v0, p1, v7}, Lorg/telegram/messenger/exoplayer/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lorg/telegram/messenger/exoplayer/upstream/DataSpec;I)V
