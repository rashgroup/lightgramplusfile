...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast p1, Lorg/telegram/messenger/exoplayer/MediaFormat;

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->adaptive:Z

    iget-boolean v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->adaptive:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->bitrate:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->bitrate:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxInputSize:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxInputSize:I

    if-ne v0, v1, :cond_0

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->durationUs:J

    iget-wide v6, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->durationUs:J
    ...
    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->width:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->height:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->height:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->rotationDegrees:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->rotationDegrees:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->pixelWidthHeightRatio:F

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->pixelWidthHeightRatio:F
    ...
    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxWidth:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxHeight:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxHeight:I
    ...
    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->sampleRate:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->pcmEncoding:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->pcmEncoding:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->encoderDelay:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->encoderDelay:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->encoderPadding:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->encoderPadding:I

    if-ne v0, v1, :cond_0

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->subsampleOffsetUs:J

    iget-wide v6, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->subsampleOffsetUs:J
    ...
    iget-object v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->trackId:Ljava/lang/String;
    ...
    iget-object v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->language:Ljava/lang/String;
    ...
    iget-object v1, p1, Lorg/telegram/messenger/exoplayer/MediaFormat;->initializationData:Ljava/util/List;
...
.method public final getFrameworkMediaFormatV16()Landroid/media/MediaFormat;
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->frameworkMediaFormat:Landroid/media/MediaFormat;
    ...
    invoke-static {v2, v0, v1}, Lorg/telegram/messenger/exoplayer/MediaFormat;->maybeSetStringV16(Landroid/media/MediaFormat;Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "max-input-size"

    iget v1, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->maxInputSize:I

    invoke-static {v2, v0, v1}, Lorg/telegram/messenger/exoplayer/MediaFormat;->maybeSetIntegerV16(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    :cond_1
    iput-object v2, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->frameworkMediaFormat:Landroid/media/MediaFormat;
...
.method public hashCode()I
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->hashCode:I
    ...
    :cond_4
    iput v0, p0, Lorg/telegram/messenger/exoplayer/MediaFormat;->hashCode:I
