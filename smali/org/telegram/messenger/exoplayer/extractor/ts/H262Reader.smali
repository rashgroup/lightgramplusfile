...
.method private static parseCsdBuffer(Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;)Landroid/util/Pair;
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->data:[B

    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->length:I
    ...
    sget-object v4, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->FRAME_RATE_VALUES:[D

    array-length v4, v4

    if-ge v3, v4, :cond_1

    sget-object v0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->FRAME_RATE_VALUES:[D

    aget-wide v0, v0, v3

    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->sequenceExtensionPosition:I
...
.method public consume(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)V
    ...
    iget-object v10, p1, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->totalBytesWritten:J
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->totalBytesWritten:J

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;
    ...
    :goto_0
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->prefixFlags:[Z

    invoke-static {v10, v0, v9, v2}, Lorg/telegram/messenger/exoplayer/util/NalUnitUtil;->findNalUnit([BII[Z)I

    move-result v8

    if-ne v8, v9, :cond_1

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->hasOutputFormat:Z
    ...
    invoke-virtual {v0, v10, v1, v9}, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->onData([BII)V
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->csdBuffer:Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;

    invoke-virtual {v2, v10, v1, v8}, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->onData([BII)V
    ...
    :goto_1
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->csdBuffer:Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;

    invoke-virtual {v1, v11, v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;->onStartCode(II)Z
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->parseCsdBuffer(Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader$CsdBuffer;)Landroid/util/Pair;

    move-result-object v1

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->frameDurationUs:J

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->hasOutputFormat:Z
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->foundFirstFrameInGroup:Z

    if-eqz v0, :cond_5

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->isKeyframe:Z
    ...
    :goto_2
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->totalBytesWritten:J

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->framePosition:J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->frameTimeUs:J
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->isKeyframe:Z
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->foundFirstFrameInGroup:Z
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->pesTimeUs:J

    :goto_4
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->frameTimeUs:J
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->framePosition:J
    ...
    :cond_a
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->frameTimeUs:J

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H262Reader;->frameDurationUs:J
