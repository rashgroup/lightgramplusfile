...
.method public endNalUnit(JI)V
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->isFirstSlice:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitHasKeyframeData:Z

    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->sampleIsKeyframe:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->isFirstParameterSet:Z
    ...
    invoke-direct {p0, v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->outputSample(I)V

    :cond_3
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitStartPosition:J

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->samplePosition:J

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitTimeUs:J

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->sampleTimeUs:J
...
.method public readNalUnitData([BII)V
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->lookingForFirstSliceFlag:Z

    if-eqz v0, :cond_0

    add-int/lit8 v0, p2, 0x2

    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitBytesRead:I
    ...
    iput-boolean v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->lookingForFirstSliceFlag:Z
    ...
    :cond_2
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitBytesRead:I

    sub-int v1, p3, p2

    add-int/2addr v0, v1

    iput v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->nalUnitBytesRead:I
