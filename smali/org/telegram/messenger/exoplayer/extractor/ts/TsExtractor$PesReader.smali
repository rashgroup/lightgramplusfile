...
.method private continueRead(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;[BI)Z
    ...
    iput v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->bytesRead:I

    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->bytesRead:I
    ...
    invoke-virtual {p1, p2, v2, v1}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->readBytes([BII)V
...
.method private parseHeader()Z
    ...
    invoke-virtual {v2, v0}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->setPosition(I)V
    ...
    iput v5, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->payloadSize:I

    :goto_0
    return v0

    :cond_0
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->pesScratch:Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->extendedHeaderLength:I

    sub-int/2addr v0, v2

    iput v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->payloadSize:I
...
.method private parseHeaderExtension()V
    ...
    invoke-virtual {v0, v1}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->setPosition(I)V

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->timeUs:J

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->ptsFlag:Z
    ...
    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->seenFirstDts:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->dtsFlag:Z
    ...
    :cond_0
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->ptsTimestampAdjuster:Lorg/telegram/messenger/exoplayer/extractor/ts/PtsTimestampAdjuster;
...
.method public consume(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;ZLorg/telegram/messenger/exoplayer/extractor/ExtractorOutput;)V
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->state:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    :pswitch_0
    invoke-direct {p0, v6}, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->setState(I)V
    ...
    :pswitch_3
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->payloadSize:I
    ...
    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->payloadSize:I
    ...
    invoke-direct {p0, p1, v0, v2}, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->continueRead(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;[BI)Z
    ...
    :goto_2
    invoke-direct {p0, v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->setState(I)V
    ...
    invoke-direct {p0, p1, v2, v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->continueRead(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;[BI)Z
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->timeUs:J

    iget-boolean v4, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/TsExtractor$PesReader;->dataAlignmentIndicator:Z

    invoke-virtual {v0, v2, v3, v4}, Lorg/telegram/messenger/exoplayer/extractor/ts/ElementaryStreamReader;->packetStarted(JZ)V
