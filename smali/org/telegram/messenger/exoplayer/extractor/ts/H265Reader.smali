...
.method private endNalUnit(JIIJ)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader$SampleReader;->endNalUnit(JI)V
    ...
    invoke-virtual {v0, p4}, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->endNalUnit(I)Z
    ...
    iget-object v0, v0, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalData:[B
    ...
    iget v1, v1, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->seiWrapper:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    invoke-virtual {v0, v4}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->skipBytes(I)V

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->seiReader:Lorg/telegram/messenger/exoplayer/extractor/ts/SeiReader;

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->seiWrapper:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    invoke-virtual {v0, p5, p6, v1}, Lorg/telegram/messenger/exoplayer/extractor/ts/SeiReader;->consume(JLorg/telegram/messenger/exoplayer/util/ParsableByteArray;)V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->isCompleted()Z
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->sps:Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->pps:Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;

    invoke-static {v1, v2, v3}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->parseMediaFormat(Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;)Lorg/telegram/messenger/exoplayer/MediaFormat;
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->hasOutputFormat:Z
...
.method private static parseMediaFormat(Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;)Lorg/telegram/messenger/exoplayer/MediaFormat;
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I

    iget v1, p1, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I

    add-int/2addr v0, v1

    iget v1, p2, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I
    ...
    iget-object v0, p1, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalData:[B

    const/4 v1, 0x0

    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I

    iget v3, p1, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I

    invoke-static {v0, v1, v8, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p2, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalData:[B
    ...
    iget v3, p2, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I
    ...
    new-instance v3, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;

    iget-object v0, p1, Lorg/telegram/messenger/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalData:[B

    invoke-direct {v3, v0}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;-><init>([B)V

    const/16 v0, 0x2c

    invoke-virtual {v3, v0}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->skipBits(I)V

    const/4 v0, 0x3

    invoke-virtual {v3, v0}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->readBits(I)I
    ...
    :cond_3
    invoke-virtual {v3}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->readUnsignedExpGolombCodedInt()I
    ...
    invoke-static {v3}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->skipScalingList(Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;)V
    ...
    :cond_c
    invoke-static {v3}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->skipShortTermRefPicSets(Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;)V
    ...
    invoke-virtual {v3, v1}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->skipBits(I)V
    ...
    invoke-virtual {v3, v1}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->readBits(I)I
    ...
    invoke-virtual {v3, v2}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->readBits(I)I
    ...
    sget-object v0, Lorg/telegram/messenger/exoplayer/util/NalUnitUtil;->ASPECT_RATIO_IDC_VALUES:[F
...
.method private static skipShortTermRefPicSets(Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;)V
    ...
    invoke-virtual {p0, v8}, Lorg/telegram/messenger/exoplayer/util/ParsableBitArray;->skipBits(I)V
...
.method public consume(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)V
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->totalBytesWritten:J
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->totalBytesWritten:J
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->prefixFlags:[Z
    ...
    invoke-direct {p0, v9, v0, v8}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->nalUnitData([BII)V

    :cond_1
    return-void

    :cond_2
    invoke-static {v9, v10}, Lorg/telegram/messenger/exoplayer/util/NalUnitUtil;->getH265NalUnitType([BI)I
    ...
    invoke-direct {p0, v9, v0, v10}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->nalUnitData([BII)V
    ...
    :goto_1
    iget-wide v6, p0, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->pesTimeUs:J

    move-object v1, p0

    invoke-direct/range {v1 .. v7}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->endNalUnit(JIIJ)V
    ...
    invoke-direct/range {v1 .. v7}, Lorg/telegram/messenger/exoplayer/extractor/ts/H265Reader;->startNalUnit(JIIJ)V
