...
.method private static isCompatibleBrand(I)Z
    ...
    :cond_1
    sget-object v3, Lorg/telegram/messenger/exoplayer/extractor/mp4/Sniffer;->COMPATIBLE_BRANDS:[I
...
.method private static sniffInternal(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Z)Z
    ...
    invoke-direct {v7, v0}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;-><init>(I)V
    ...
    iget-object v2, v7, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    const/4 v3, 0x0

    invoke-interface {p0, v2, v3, v4}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->peekFully([BII)V

    const/4 v2, 0x0

    invoke-virtual {v7, v2}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->setPosition(I)V

    invoke-virtual {v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->readUnsignedInt()J

    move-result-wide v2

    invoke-virtual {v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->readInt()I
    ...
    invoke-interface {p0, v2, v3, v9}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->peekFully([BII)V

    invoke-virtual {v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->readUnsignedLongToLong()J
    ...
    sget v9, Lorg/telegram/messenger/exoplayer/extractor/mp4/Atom;->TYPE_moov:I
    ...
    sget v9, Lorg/telegram/messenger/exoplayer/extractor/mp4/Atom;->TYPE_mvex:I
    ...
    sget v4, Lorg/telegram/messenger/exoplayer/extractor/mp4/Atom;->TYPE_ftyp:I
    ...
    :cond_8
    invoke-virtual {v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->capacity()I
    ...
    invoke-virtual {v7, v4, v2}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->reset([BI)V

    :cond_9
    iget-object v4, v7, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    const/4 v5, 0x0

    invoke-interface {p0, v4, v5, v2}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->peekFully([BII)V
    ...
    invoke-virtual {v7, v5}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->skipBytes(I)V
    ...
    invoke-static {v5}, Lorg/telegram/messenger/exoplayer/extractor/mp4/Sniffer;->isCompatibleBrand(I)Z
