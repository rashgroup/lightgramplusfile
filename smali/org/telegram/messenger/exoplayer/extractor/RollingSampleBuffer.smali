...
.method private dropDownstreamTo(J)V
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->totalBytesDropped:J
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->allocator:Lorg/telegram/messenger/exoplayer/upstream/Allocator;
    ...
    invoke-interface {v3, v0}, Lorg/telegram/messenger/exoplayer/upstream/Allocator;->release(Lorg/telegram/messenger/exoplayer/upstream/Allocation;)V
...
.method private dropUpstreamFrom(J)V
    ...
    invoke-interface {v4, v0}, Lorg/telegram/messenger/exoplayer/upstream/Allocator;->release(Lorg/telegram/messenger/exoplayer/upstream/Allocation;)V
...
.method private readData(JLjava/nio/ByteBuffer;I)V
    ...
    iget-object v3, v0, Lorg/telegram/messenger/exoplayer/upstream/Allocation;->data:[B
...
.method private readData(J[BI)V
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->totalBytesDropped:J
...
.method private readEncryptionData(Lorg/telegram/messenger/exoplayer/SampleHolder;Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;)V
    ...
    iget-wide v0, p2, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;->offset:J

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    invoke-direct {p0, v0, v1, v2, v6}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readData(J[BI)V

    const-wide/16 v2, 0x1

    add-long/2addr v2, v0

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    iget-object v5, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->cryptoInfo:Lorg/telegram/messenger/exoplayer/CryptoInfo;

    iget-object v5, v5, Lorg/telegram/messenger/exoplayer/CryptoInfo;->iv:[B
    ...
    iput-object v7, v5, Lorg/telegram/messenger/exoplayer/CryptoInfo;->iv:[B
    ...
    invoke-direct {p0, v2, v3, v5, v1}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readData(J[BI)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v1, v1, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    const/4 v5, 0x2

    invoke-direct {p0, v2, v3, v1, v5}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readData(J[BI)V
    ...
    invoke-virtual {v1, v4}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->setPosition(I)V
    ...
    :goto_1
    iget-object v2, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->cryptoInfo:Lorg/telegram/messenger/exoplayer/CryptoInfo;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/CryptoInfo;->numBytesOfClearData:[I
    ...
    :cond_2
    iget-object v3, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->cryptoInfo:Lorg/telegram/messenger/exoplayer/CryptoInfo;

    iget-object v3, v3, Lorg/telegram/messenger/exoplayer/CryptoInfo;->numBytesOfEncryptedData:[I
    ...
    iget-object v5, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    invoke-static {v5, v0}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->ensureCapacity(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;I)V

    iget-object v5, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v5, v5, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    invoke-direct {p0, v8, v9, v5, v0}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readData(J[BI)V
    ...
    iget v0, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->size:I

    iget-wide v10, p2, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;->offset:J
    ...
    :cond_8
    iget-object v0, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->cryptoInfo:Lorg/telegram/messenger/exoplayer/CryptoInfo;

    iget-object v4, p2, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;->encryptionKeyId:[B

    iget-object v5, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->cryptoInfo:Lorg/telegram/messenger/exoplayer/CryptoInfo;

    iget-object v5, v5, Lorg/telegram/messenger/exoplayer/CryptoInfo;->iv:[B

    invoke-virtual/range {v0 .. v6}, Lorg/telegram/messenger/exoplayer/CryptoInfo;->set(I[I[I[B[BI)V
    ...
    iget-wide v2, p2, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;->offset:J

    int-to-long v4, v0

    add-long/2addr v2, v4

    iput-wide v2, p2, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;->offset:J
...
.method public appendData(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;IZ)I
    ...
    invoke-interface {p1, v2, v3, v1}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->read([BII)I
...
.method public appendData(Lorg/telegram/messenger/exoplayer/upstream/DataSource;IZ)I
    ...
    invoke-interface {p1, v2, v3, v1}, Lorg/telegram/messenger/exoplayer/upstream/DataSource;->read([BII)I
...
.method public readSample(Lorg/telegram/messenger/exoplayer/SampleHolder;)Z
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->extrasHolder:Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;

    invoke-direct {p0, p1, v0}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readEncryptionData(Lorg/telegram/messenger/exoplayer/SampleHolder;Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$SampleExtrasHolder;)V

    :cond_1
    iget v0, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->size:I

    invoke-virtual {p1, v0}, Lorg/telegram/messenger/exoplayer/SampleHolder;->ensureSpaceForWrite(I)V
    ...
    iget v3, p1, Lorg/telegram/messenger/exoplayer/SampleHolder;->size:I

    invoke-direct {p0, v0, v1, v2, v3}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->readData(JLjava/nio/ByteBuffer;I)V

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer;->infoQueue:Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;

    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->moveToNextSample()J
...
.method public skipToKeyframeBefore(J)Z
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->skipToKeyframeBefore(J)J
