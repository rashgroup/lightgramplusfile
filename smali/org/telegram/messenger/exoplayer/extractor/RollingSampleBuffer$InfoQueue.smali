...
.method public declared-synchronized commitSample(JIJI[B)V
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeWriteIndex:I
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->capacity:I
    ...
    iget v6, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->capacity:I

    iget v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeReadIndex:I

    sub-int/2addr v6, v7

    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->offsets:[J

    iget v8, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeReadIndex:I

    const/4 v9, 0x0

    invoke-static {v7, v8, v1, v9, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->timesUs:[J
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->flags:[I
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->sizes:[I
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->encryptionKeys:[[B
    ...
    iput-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->offsets:[J

    iput-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->timesUs:[J

    iput-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->flags:[I

    iput-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->sizes:[I

    iput-object v5, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->encryptionKeys:[[B
    ...
    iput v1, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeWriteIndex:I
    ...
    :cond_1
    :try_start_1
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeWriteIndex:I
...
.method public declared-synchronized skipToKeyframeBefore(J)J
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->timesUs:[J

    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeReadIndex:I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->timesUs:[J
    ...
    :goto_2
    iget v6, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->relativeWriteIndex:I

    if-eq v4, v6, :cond_2

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->timesUs:[J
    ...
    :cond_4
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/extractor/RollingSampleBuffer$InfoQueue;->flags:[I
