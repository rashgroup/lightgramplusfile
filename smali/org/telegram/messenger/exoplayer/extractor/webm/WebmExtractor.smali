...
.method private buildSeekMap()Lorg/telegram/messenger/exoplayer/extractor/SeekMap;
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->segmentContentPosition:J

    cmp-long v1, v2, v4

    if-eqz v1, :cond_0

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->durationUs:J

    cmp-long v1, v2, v4

    if-eqz v1, :cond_0

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->cueTimesUs:Lorg/telegram/messenger/exoplayer/util/LongArray;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->cueTimesUs:Lorg/telegram/messenger/exoplayer/util/LongArray;

    invoke-virtual {v1}, Lorg/telegram/messenger/exoplayer/util/LongArray;->size()I

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->cueClusterPositions:Lorg/telegram/messenger/exoplayer/util/LongArray;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->cueTimesUs:Lorg/telegram/messenger/exoplayer/util/LongArray;

    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer/util/LongArray;->size()I
    ...
    invoke-virtual {v7, v1}, Lorg/telegram/messenger/exoplayer/util/LongArray;->get(I)J
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->cueClusterPositions:Lorg/telegram/messenger/exoplayer/util/LongArray;
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer/extractor/ChunkIndex;

    invoke-direct {v0, v3, v4, v5, v6}, Lorg/telegram/messenger/exoplayer/extractor/ChunkIndex;-><init>([I[J[J[J)V
...
.method private readToOutput(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;I)I
    ...
    invoke-interface {p2, v1, v0}, Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;I)V
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleBytesWritten:I

    add-int/2addr v1, v0

    iput v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleBytesWritten:I
    ...
    invoke-interface {p2, p1, p3, v0}, Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;IZ)I
...
.method private readToTarget(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;[BII)V
    ...
    :cond_0
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleBytesRead:I
...
.method private static setSubripSampleEndTimecode([BJ)V
    ...
    sget-object v0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->SUBRIP_TIMECODE_EMPTY:[B
...
.method private writeSampleData(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;I)V
    ...
    iget-object v1, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecId:Ljava/lang/String;
    ...
    sget-object v0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->SUBRIP_PREFIX:[B
    ...
    sget-object v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->SUBRIP_PREFIX:[B
    ...
    iput-object v2, v1, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B
    ...
    invoke-interface {p1, v1, v2, p3}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->readFully([BII)V

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->subripSample:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    invoke-virtual {v1, v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->setPosition(I)V
    ...
    :cond_2
    iget-object v0, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;

    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleEncodingHandled:Z

    if-nez v1, :cond_5

    iget-boolean v1, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->hasContentEncryption:Z

    if-eqz v1, :cond_7

    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockFlags:I

    and-int/lit8 v1, v1, -0x3

    iput v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockFlags:I

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v1, v1, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B

    invoke-interface {p1, v1, v7, v4}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->readFully([BII)V
    ...
    :cond_4
    :goto_1
    iput-boolean v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleEncodingHandled:Z
    ...
    iget-object v3, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecId:Ljava/lang/String;
    ...
    :cond_6
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->nalLength:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    iget v3, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->nalUnitLengthFieldLength:I

    iget v4, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->nalUnitLengthFieldLength:I
    ...
    invoke-direct {p0, p1, v2, v4, v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->readToTarget(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;[BII)V
    ...
    invoke-virtual {v5, v7}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->setPosition(I)V
    ...
    invoke-interface {v0, v5, v8}, Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;I)V
    ...
    :cond_7
    iget-object v1, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleStrippedBytes:[B

    if-eqz v1, :cond_4

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleStrippedBytes:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v2, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleStrippedBytes:[B

    iget-object v3, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleStrippedBytes:[B

    array-length v3, v3

    invoke-virtual {v1, v2, v3}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->reset([BI)V
    ...
    invoke-direct {p0, p1, v0, v6}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->readToOutput(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;I)I
    ...
    invoke-direct {p0, p1, v0, v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->readToOutput(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;I)I
    ...
    iget-object v2, p2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecId:Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->vorbisNumPageSamples:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
...
.method binaryElement(IILorg/telegram/messenger/exoplayer/extractor/ExtractorInput;)V
    ...
    :sswitch_0
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->seekEntryIdBytes:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    invoke-interface {v0, v2, v3, v1}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->readFully([BII)V
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->readUnsignedInt()J

    move-result-wide v2

    long-to-int v2, v2

    iput v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->seekEntryId:I
    ...
    iput-object v3, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->currentTrack:Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B
    ...
    iput-object v3, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleStrippedBytes:[B

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->currentTrack:Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleStrippedBytes:[B
    ...
    iput-object v3, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->encryptionKeyId:[B

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->currentTrack:Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->encryptionKeyId:[B
    ...
    :sswitch_4
    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockState:I

    if-nez v2, :cond_0

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->varintReader:Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;
    ...
    invoke-virtual {v2, v0, v3, v4, v5}, Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;->readUnsignedVarint(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;ZZI)J

    move-result-wide v2

    long-to-int v2, v2

    iput v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumber:I

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->varintReader:Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;

    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;->getLastLength()I

    move-result v2

    iput v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumberLength:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockDurationUs:J

    const/4 v2, 0x1

    iput v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockState:I
    ...
    :cond_0
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->tracks:Landroid/util/SparseArray;

    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumber:I

    invoke-virtual {v2, v3}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;

    if-nez v2, :cond_1

    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumberLength:I
    ...
    :cond_1
    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockState:I
    ...
    invoke-direct {p0, v0, v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->readScratch(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)V

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    iput v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleCount:I

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    const/4 v4, 0x1

    invoke-static {v3, v4}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->ensureArrayCapacity([II)[I

    move-result-object v3

    iput-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    const/4 v4, 0x0

    iget v5, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumberLength:I
    ...
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->clusterTimecodeUs:J

    int-to-long v6, v3

    invoke-direct {p0, v6, v7}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scaleTimecodeToUs(J)J

    move-result-wide v6

    add-long/2addr v4, v6

    iput-wide v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTimeUs:J
    ...
    :goto_2
    iget v4, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->type:I
    ...
    iput v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockFlags:I

    const/4 v3, 0x2

    iput v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockState:I

    const/4 v3, 0x0

    iput v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleIndex:I
    ...
    :goto_6
    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleIndex:I

    iget v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleCount:I

    if-ge v3, v4, :cond_17

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    iget v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleIndex:I

    aget v3, v3, v4

    move-object/from16 v0, p3

    invoke-direct {p0, v0, v2, v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->writeSampleData(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;I)V

    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTimeUs:J

    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleIndex:I

    iget v6, v2, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->defaultSampleDurationNs:I
    ...
    invoke-direct {p0, v2, v4, v5}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->commitSampleToOutput(Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;J)V
    ...
    invoke-direct {p0, v0, v4}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->readScratch(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)V
    ...
    iput v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleCount:I

    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    iget v5, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleCount:I

    invoke-static {v4, v5}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->ensureArrayCapacity([II)[I

    move-result-object v4

    iput-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I

    const/4 v4, 0x2

    if-ne v3, v4, :cond_6

    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumberLength:I
    ...
    iget v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleCount:I
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I
    ...
    iget v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockTrackNumberLength:I
    ...
    iget-object v9, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->scratch:Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;

    iget-object v9, v9, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B
    ...
    iget-object v9, v6, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B
    ...
    iget-object v7, v6, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;->data:[B
    ...
    :cond_10
    iget-object v8, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->blockLacingSampleSizes:[I
...
.method public read(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;Lorg/telegram/messenger/exoplayer/extractor/PositionHolder;)I
    ...
    iget-boolean v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->sampleRead:Z
    ...
    invoke-direct {p0, p2, v4, v5}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor;->maybeSeekForCues(Lorg/telegram/messenger/exoplayer/extractor/PositionHolder;J)Z
