...
.method private maybeResyncToNextLevel1Element(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;)J
    ...
    :goto_0
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->scratch:[B

    invoke-interface {p1, v0, v4, v5}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->peekFully([BII)V
    ...
    invoke-static {v1, v0, v4}, Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;->assembleVarint([BIZ)J
    ...
    invoke-interface {v2, v1}, Lorg/telegram/messenger/exoplayer/extractor/webm/EbmlReaderOutput;->isLevel1Element(I)Z
...
.method private readInteger(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)J
    ...
    invoke-interface {p1, v1, v0, p2}, Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;->readFully([BII)V
...
.method public read(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;)Z
    ...
    invoke-virtual {v0, p1, v6, v7, v1}, Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;->readUnsignedVarint(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;ZZI)J
    ...
    iput v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->elementState:I
    ...
    invoke-virtual {v0, p1, v7, v6, v1}, Lorg/telegram/messenger/exoplayer/extractor/webm/VarintReader;->readUnsignedVarint(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;ZZI)J
    ...
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->masterElementsStack:Ljava/util/Stack;

    new-instance v5, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader$MasterElement;

    iget v8, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->elementId:I

    const/4 v9, 0x0

    invoke-direct {v5, v8, v0, v1, v9}, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader$MasterElement;-><init>(IJLorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader$1;)V
    ...
    iput v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->elementState:I
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->elementContentSize:J
    ...
    invoke-direct {p0, p1, v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->readInteger(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)J

    move-result-wide v2

    invoke-interface {v0, v1, v2, v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/EbmlReaderOutput;->integerElement(IJ)V
    ...
    invoke-direct {p0, p1, v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->readFloat(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)D

    move-result-wide v2

    invoke-interface {v0, v1, v2, v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/EbmlReaderOutput;->floatElement(ID)V
    ...
    invoke-direct {p0, p1, v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/DefaultEbmlReader;->readString(Lorg/telegram/messenger/exoplayer/extractor/ExtractorInput;I)Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, v1, v2}, Lorg/telegram/messenger/exoplayer/extractor/webm/EbmlReaderOutput;->stringElement(ILjava/lang/String;)V
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/telegram/messenger/exoplayer/extractor/webm/EbmlReaderOutput;->binaryElement(IILorg/telegram/messenger/exoplayer/extractor/ExtractorInput;)V
