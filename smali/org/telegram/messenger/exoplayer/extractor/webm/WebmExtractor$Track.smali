...
.method public initializeOutput(Lorg/telegram/messenger/exoplayer/extractor/ExtractorOutput;IJ)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecId:Ljava/lang/String;
    ...
    iget v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->channelCount:I

    iget v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->sampleRate:I

    iget-object v9, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->language:Ljava/lang/String;
    ...
    :goto_2
    iget v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->number:I
    ...
    iput-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->output:Lorg/telegram/messenger/exoplayer/extractor/TrackOutput;
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B
    ...
    :cond_1
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B

    invoke-direct {v0, v1}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;-><init>([B)V

    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->parseAvcCodecPrivate(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)Landroid/util/Pair;
    ...
    iput v1, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->nalUnitLengthFieldLength:I
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->parseHevcCodecPrivate(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)Landroid/util/Pair;
    ...
    invoke-direct {v0, v3}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;-><init>([B)V

    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->parseFourCcVc1Private(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)Ljava/util/List;
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->parseVorbisCodecPrivate([B)Ljava/util/List;
    ...
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecPrivate:[B
    ...
    iget-wide v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->codecDelayNs:J
    ...
    iget-wide v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->seekPreRollNs:J
    ...
    invoke-direct {v3, v4}, Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;-><init>([B)V

    invoke-static {v3}, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->parseMsAcmCodecPrivate(Lorg/telegram/messenger/exoplayer/util/ParsableByteArray;)Z
    ...
    :cond_2
    iget v3, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->audioBitDepth:I

    invoke-static {v3}, Lorg/telegram/messenger/exoplayer/util/Util;->getPcmEncoding(I)I
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->audioBitDepth:I
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayUnit:I

    if-nez v0, :cond_4

    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayWidth:I

    if-ne v0, v2, :cond_6

    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->width:I

    :goto_4
    iput v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayWidth:I

    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayHeight:I

    if-ne v0, v2, :cond_7

    iget v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->height:I

    :goto_5
    iput v0, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayHeight:I
    ...
    iget v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayWidth:I

    mul-int/2addr v0, v4

    int-to-float v0, v0

    iget v4, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->width:I

    iget v5, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->displayHeight:I
    ...
    iget v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->width:I

    iget v7, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->height:I
    ...
    iget-object v5, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->language:Ljava/lang/String;

    move-wide v3, p3

    invoke-static/range {v0 .. v5}, Lorg/telegram/messenger/exoplayer/MediaFormat;->createTextFormat(Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;)Lorg/telegram/messenger/exoplayer/MediaFormat;
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/extractor/webm/WebmExtractor$Track;->language:Ljava/lang/String;

    move-wide v3, p3

    move-object v5, v8

    invoke-static/range {v0 .. v6}, Lorg/telegram/messenger/exoplayer/MediaFormat;->createImageFormat(Ljava/lang/String;Ljava/lang/String;IJLjava/util/List;Ljava/lang/String;)Lorg/telegram/messenger/exoplayer/MediaFormat;
