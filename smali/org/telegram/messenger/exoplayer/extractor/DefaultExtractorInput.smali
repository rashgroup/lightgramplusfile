...
.method private readFromDataSource([BIIIZ)I
    ...
    :cond_0
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/extractor/DefaultExtractorInput;->dataSource:Lorg/telegram/messenger/exoplayer/upstream/DataSource;

    add-int v2, p2, p4

    sub-int v3, p3, p4

    invoke-interface {v1, p1, v2, v3}, Lorg/telegram/messenger/exoplayer/upstream/DataSource;->read([BII)I
...
.method private readFromPeekBuffer([BII)I
    ...
    invoke-direct {p0, v1}, Lorg/telegram/messenger/exoplayer/extractor/DefaultExtractorInput;->updatePeekBuffer(I)V
...
.method public read([BII)I
    ...
    :cond_0
    invoke-direct {p0, v0}, Lorg/telegram/messenger/exoplayer/extractor/DefaultExtractorInput;->commitBytesRead(I)V
