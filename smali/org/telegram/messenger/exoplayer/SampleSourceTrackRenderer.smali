...
.method public varargs constructor <init>([Lorg/telegram/messenger/exoplayer/SampleSource;)V
    ...
    new-array v0, v0, [Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->sources:[Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;
...
.method private checkForDiscontinuity(J)J
    ...
    invoke-interface {v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->readDiscontinuity(I)J
...
.method protected final doPrepare(J)Z
    ...
    iget-object v4, v0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->sources:[Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;
    ...
    invoke-interface {v4, v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->prepare(J)Z
    ...
    invoke-interface {v4}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->getTrackCount()I
    ...
    iget-object v2, v0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->sources:[Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;
    ...
    invoke-interface {v7}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->getTrackCount()I
    ...
    invoke-interface {v7, v3}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->getFormat(I)Lorg/telegram/messenger/exoplayer/MediaFormat;
    ...
    invoke-virtual {v0, v12}, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->handlesTrack(Lorg/telegram/messenger/exoplayer/MediaFormat;)Z
    :try_end_0
    ...
    invoke-direct {v3, v2}, Lorg/telegram/messenger/exoplayer/ExoPlaybackException;-><init>(Ljava/lang/Throwable;)V

    throw v3

    :cond_4
    iget-wide v12, v12, Lorg/telegram/messenger/exoplayer/MediaFormat;->durationUs:J
    ...
    iput-wide v4, v0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->durationUs:J
    ...
    iput-object v2, v0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->handledSourceIndices:[I
    ...
    iput-object v2, v0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->handledSourceTrackIndices:[I
...
.method protected final doSomeWork(JJ)V
    ...
    invoke-interface {v2, v3, v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->continueBuffering(IJ)Z

    move-result v6

    invoke-direct {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->checkForDiscontinuity(J)J
...
.method protected maybeThrowError()V
    ...
    invoke-direct {p0, v0}, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->maybeThrowError(Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;)V
...
.method protected onEnabled(IJZ)V
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->handledSourceIndices:[I

    aget v3, v3, p1

    aget-object v2, v2, v3

    iput-object v2, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->enabledSource:Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->handledSourceTrackIndices:[I

    aget v2, v2, p1

    iput v2, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->enabledSourceTrackIndex:I

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->enabledSource:Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;

    iget v3, p0, Lorg/telegram/messenger/exoplayer/SampleSourceTrackRenderer;->enabledSourceTrackIndex:I

    invoke-interface {v2, v3, v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->enable(IJ)V
...
.method protected final seekTo(J)V
    ...
    invoke-interface {v2, v0, v1}, Lorg/telegram/messenger/exoplayer/SampleSource$SampleSourceReader;->seekToUs(J)V
