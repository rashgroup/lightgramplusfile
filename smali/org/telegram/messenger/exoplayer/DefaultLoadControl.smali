...
.method private getLoaderBufferState(JJ)I
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->lowWatermarkUs:J
...
.method private updateControlState()V
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->bufferState:I
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->loaders:Ljava/util/List;
    ...
    iget-boolean v6, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->loading:Z

    or-int/2addr v5, v6

    iget-wide v8, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->nextLoadPositionUs:J
    ...
    iget v0, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->bufferState:I
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->fillingBuffers:Z
    ...
    :goto_2
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->fillingBuffers:Z

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->fillingBuffers:Z

    if-eqz v0, :cond_8

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->streamingPrioritySet:Z
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/messenger/exoplayer/upstream/NetworkLock;->add(I)V

    iput-boolean v7, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->streamingPrioritySet:Z

    invoke-direct {p0, v7}, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->notifyLoadingChanged(Z)V

    :cond_4
    :goto_3
    iput-wide v10, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->maxLoadStartPositionUs:J
    ...
    iget-wide v0, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->nextLoadPositionUs:J

    cmp-long v3, v0, v10

    if-eqz v3, :cond_6

    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->maxLoadStartPositionUs:J
    ...
    :cond_5
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->maxLoadStartPositionUs:J
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/messenger/exoplayer/upstream/NetworkLock;->remove(I)V

    iput-boolean v2, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->streamingPrioritySet:Z

    invoke-direct {p0, v2}, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->notifyLoadingChanged(Z)V
...
.method public unregister(Ljava/lang/Object;)V
    ...
    iget v0, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->bufferSizeContribution:I
...
.method public update(Ljava/lang/Object;JJZ)Z
    ...
    iget v3, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->bufferState:I

    if-ne v3, v4, :cond_0

    iget-wide v6, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->nextLoadPositionUs:J

    cmp-long v3, v6, p4

    if-nez v3, :cond_0

    iget-boolean v3, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->loading:Z
    ...
    iput v4, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->bufferState:I

    iput-wide p4, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->nextLoadPositionUs:J

    iput-boolean p6, v0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl$LoaderState;->loading:Z

    :cond_1
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->allocator:Lorg/telegram/messenger/exoplayer/upstream/Allocator;

    invoke-interface {v0}, Lorg/telegram/messenger/exoplayer/upstream/Allocator;->getTotalBytesAllocated()I

    move-result v4

    invoke-direct {p0, v4}, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->getBufferState(I)I
    ...
    iput v5, p0, Lorg/telegram/messenger/exoplayer/DefaultLoadControl;->bufferState:I
