...
.method public addSample(IF)V
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSampleCount:I

    if-lez v0, :cond_1

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSamples:[Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;

    iget v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSampleCount:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSampleCount:I

    aget-object v0, v0, v1

    :goto_0
    iget v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->nextSampleIndex:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->nextSampleIndex:I

    iput v1, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->index:I

    iput p1, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->weight:I

    iput p2, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->value:F

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->samples:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget v0, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->totalWeight:I

    add-int/2addr v0, p1

    iput v0, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->totalWeight:I

    :cond_0
    :goto_1
    iget v0, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->totalWeight:I

    iget v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->maxWeight:I
    ...
    check-cast v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;

    iget v2, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->weight:I

    if-gt v2, v1, :cond_2

    iget v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->totalWeight:I

    iget v2, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->weight:I

    sub-int/2addr v1, v2

    iput v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->totalWeight:I
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSamples:[Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;

    iget v2, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSampleCount:I

    add-int/lit8 v3, v2, 0x1

    iput v3, p0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile;->recycledSampleCount:I
    ...
    :cond_1
    new-instance v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;-><init>(Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$1;)V
    ...
    iput v2, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->weight:I
...
.method public getPercentile(F)F
    ...
    iget v4, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->weight:I
    ...
    iget v0, v0, Lorg/telegram/messenger/exoplayer/util/SlidingPercentile$Sample;->value:F
