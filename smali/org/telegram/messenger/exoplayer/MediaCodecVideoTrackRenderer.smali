...
.method private maybeNotifyDrawnToSurface()V
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->reportedDrawnToSurface:Z
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->reportedDrawnToSurface:Z
...
.method private maybeNotifyDroppedFrameCount()V
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->droppedFrameCount:I

    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->droppedFrameAccumulationStartTimeMs:J

    sub-long v4, v0, v4

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->eventHandler:Landroid/os/Handler;

    new-instance v6, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer$3;

    invoke-direct {v6, p0, v2, v4, v5}, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer$3;-><init>(Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;IJ)V

    invoke-virtual {v3, v6}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v2, 0x0

    iput v2, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->droppedFrameCount:I
...
.method private maybeSetMaxInputSize(Landroid/media/MediaFormat;Z)V
    ...
    sget-object v4, Lorg/telegram/messenger/exoplayer/util/Util;->MODEL:Ljava/lang/String;
...
.method protected onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->pendingPixelWidthHeightRatio:F

    iput v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->currentPixelWidthHeightRatio:F
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->pendingRotationDegrees:I
    ...
    :cond_0
    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->currentWidth:I

    iget v1, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->currentHeight:I

    iput v1, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->currentWidth:I
    ...
    :cond_1
    :goto_3
    iget v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->videoScalingMode:I
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->currentUnappliedRotationDegrees:I
...
.method protected processOutputBuffer(JJLandroid/media/MediaCodec;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;IZ)Z
    ...
    invoke-virtual {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->skipOutputBuffer(Landroid/media/MediaCodec;I)V

    const/4 v2, 0x0

    iput v2, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->consecutiveDroppedFrameCount:I
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->renderOutputBufferV21(Landroid/media/MediaCodec;IJ)V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->renderOutputBuffer(Landroid/media/MediaCodec;I)V
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->frameReleaseTimeHelper:Lorg/telegram/messenger/exoplayer/VideoFrameReleaseTimeHelper;

    move-object/from16 v0, p7

    iget-wide v8, v0, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    invoke-virtual {v6, v8, v9, v2, v3}, Lorg/telegram/messenger/exoplayer/VideoFrameReleaseTimeHelper;->adjustReleaseTime(JJ)J
    ...
    invoke-virtual {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/MediaCodecVideoTrackRenderer;->dropOutputBuffer(Landroid/media/MediaCodec;I)V
    ...
    :cond_4
    sget v6, Lorg/telegram/messenger/exoplayer/util/Util;->SDK_INT:I
