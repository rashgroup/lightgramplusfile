...
.method private maybeSampleSyncParams()V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getPlaybackHeadPositionUs()J
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->lastPlayheadSampleTimeUs:J
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->playheadOffsets:[J

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->nextPlayheadOffsetIndex:I

    sub-long v6, v2, v4

    aput-wide v6, v0, v1

    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->nextPlayheadOffsetIndex:I
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->playheadOffsetCount:I
    ...
    :cond_2
    iput-wide v4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->lastPlayheadSampleTimeUs:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->smoothedPlayheadOffsetUs:J

    const/4 v0, 0x0

    :goto_1
    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->playheadOffsetCount:I

    if-ge v0, v1, :cond_3

    iget-wide v6, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->smoothedPlayheadOffsetUs:J

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->playheadOffsets:[J
    ...
    iput-wide v6, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->smoothedPlayheadOffsetUs:J
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->lastTimestampSampleTimeUs:J
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->updateTimestamp()Z

    move-result v0

    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTimestampSet:Z

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTimestampSet:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getTimestampNanoTime()J
    ...
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v6}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getTimestampFramePosition()J

    move-result-wide v6

    iget-wide v8, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resumeSystemTimeUs:J
    ...
    :cond_4
    :goto_2
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->getLatencyMethod:Ljava/lang/reflect/Method;
    ...
    :try_start_0
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->getLatencyMethod:Ljava/lang/reflect/Method;
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferSizeUs:J

    sub-long/2addr v0, v2

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->latencyUs:J

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->latencyUs:J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->latencyUs:J
    ...
    :cond_5
    :goto_3
    iput-wide v4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->lastTimestampSampleTimeUs:J
    ...
    sget-boolean v1, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->failOnSpuriousAudioTimestamp:Z

    if-eqz v1, :cond_7

    new-instance v1, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$InvalidAudioTrackTimestampException;

    invoke-direct {v1, v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$InvalidAudioTrackTimestampException;-><init>(Ljava/lang/String;)V
    ...
    :cond_8
    invoke-direct {p0, v6, v7}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesToDurationUs(J)J
...
.method public configure(Ljava/lang/String;IIII)V
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sourceEncoding:I

    if-ne v1, p4, :cond_3

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sampleRate:I

    if-ne v1, p3, :cond_3

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->channelConfig:I
    ...
    :pswitch_7
    sget v0, Lorg/telegram/messenger/exoplayer/C;->CHANNEL_OUT_7POINT1_SURROUND:I
    ...
    iput p4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sourceEncoding:I

    iput-boolean v3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->passthrough:Z

    iput p3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sampleRate:I

    iput v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->channelConfig:I

    if-eqz v3, :cond_4

    :goto_3
    iput p4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->targetEncoding:I

    mul-int/lit8 v1, p2, 0x2

    iput v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->pcmFrameSize:I

    if-eqz p5, :cond_5

    iput p5, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferSize:I
    ...
    :goto_5
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferSizeUs:J
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferSize:I
    ...
    :cond_8
    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->targetEncoding:I
    ...
    invoke-direct {p0, v4, v5}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->durationUsToFrames(J)J

    move-result-wide v4

    long-to-int v0, v4

    iget v4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->pcmFrameSize:I
    ...
    invoke-direct {p0, v6, v7}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->durationUsToFrames(J)J

    move-result-wide v6

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->pcmFrameSize:I
    ...
    invoke-direct {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesToDurationUs(J)J
...
.method public getCurrentPositionUs(Z)J
    ...
    invoke-direct {p0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->hasCurrentPositionUs()Z
    ...
    invoke-direct {p0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->maybeSampleSyncParams()V
    ...
    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTimestampSet:Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getTimestampNanoTime()J
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getPlaybackSpeed()F
    ...
    invoke-direct {p0, v0, v1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->durationUsToFrames(J)J

    move-result-wide v0

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getTimestampFramePosition()J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->startMediaTimeUs:J
    ...
    :cond_3
    iget v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->playheadOffsetCount:I
    ...
    :cond_4
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->smoothedPlayheadOffsetUs:J
...
.method public handleBuffer(Ljava/nio/ByteBuffer;IIJ)I
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getPlaybackHeadPosition()J
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sourceEncoding:I
    ...
    :goto_1
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->useResampledBuffer:Z

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->useResampledBuffer:Z
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->sourceEncoding:I

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resampledBuffer:Ljava/nio/ByteBuffer;

    invoke-static {p1, p2, p3, v0, v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resampleTo16BitPcm(Ljava/nio/ByteBuffer;IIILjava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    move-result-object v0

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resampledBuffer:Ljava/nio/ByteBuffer;

    iget-object p1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resampledBuffer:Ljava/nio/ByteBuffer;

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->resampledBuffer:Ljava/nio/ByteBuffer;
    ...
    :cond_4
    iput p3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesPerEncodedSample:I

    if-nez v0, :cond_5

    iget v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->targetEncoding:I

    invoke-static {v0, p1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->getFramesPerEncodedSample(ILjava/nio/ByteBuffer;)I

    move-result v0

    iput v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesPerEncodedSample:I
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->startMediaTimeUs:J
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBuffer:[B
    ...
    iput-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBuffer:[B
    ...
    iput v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBufferOffset:I
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->submittedPcmBytes:J

    iget-object v4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v4}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->getPlaybackHeadPosition()J

    move-result-wide v4

    iget v6, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->pcmFrameSize:I
    ...
    iget v3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferSize:I

    sub-int v2, v3, v2

    if-lez v2, :cond_9

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBuffer:[B

    iget v4, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBufferOffset:I
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBufferOffset:I

    add-int/2addr v2, v1

    iput v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->temporaryBufferOffset:I

    :cond_9
    :goto_5
    if-gez v1, :cond_10

    new-instance v0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$WriteException;

    invoke-direct {v0, v1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$WriteException;-><init>(I)V
    ...
    invoke-direct {p0, v4, v5}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesToDurationUs(J)J
    ...
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->startMediaTimeUs:J

    sub-long v2, p4, v2

    add-long/2addr v0, v2

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->startMediaTimeUs:J
    ...
    :cond_e
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->useResampledBuffer:Z
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I

    invoke-static {v1, p1, v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->writeNonBlockingV21(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;I)I
    ...
    iput v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I

    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->passthrough:Z
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->submittedPcmBytes:J
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->passthrough:Z

    if-eqz v1, :cond_12

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->submittedEncodedFrames:J

    iget v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesPerEncodedSample:I

    int-to-long v4, v1

    add-long/2addr v2, v4

    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->submittedEncodedFrames:J
...
.method public initialize(I)I
    ...
    invoke-virtual {v0, v1, v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->reconfigure(Landroid/media/AudioTrack;Z)V
...
.method public reset()V
    ...
    iput v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->framesPerEncodedSample:I

    iput v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->bufferBytesRemaining:I

    iput v2, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->startMediaTimeState:I
    ...
    iput-object v3, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrack:Landroid/media/AudioTrack;

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->audioTrackUtil:Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;

    invoke-virtual {v1, v3, v2}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$AudioTrackUtil;->reconfigure(Landroid/media/AudioTrack;Z)V

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/audio/AudioTrack;->releasingConditionVariable:Landroid/os/ConditionVariable;

    invoke-virtual {v1}, Landroid/os/ConditionVariable;->close()V

    new-instance v1, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$1;

    invoke-direct {v1, p0, v0}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$1;-><init>(Lorg/telegram/messenger/exoplayer/audio/AudioTrack;Landroid/media/AudioTrack;)V

    invoke-virtual {v1}, Lorg/telegram/messenger/exoplayer/audio/AudioTrack$1;->start()V
