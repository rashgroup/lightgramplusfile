...
.method public constructor <init>(ILorg/telegram/messenger/exoplayer/dash/mpd/MediaPresentationDescription;ILorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;)V
    ...
    invoke-virtual {p2, p3}, Lorg/telegram/messenger/exoplayer/dash/mpd/MediaPresentationDescription;->getPeriod(I)Lorg/telegram/messenger/exoplayer/dash/mpd/Period;

    move-result-object v1

    invoke-static {p2, p3}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->getPeriodDurationUs(Lorg/telegram/messenger/exoplayer/dash/mpd/MediaPresentationDescription;I)J

    move-result-wide v4

    iget-object v0, v1, Lorg/telegram/messenger/exoplayer/dash/mpd/Period;->adaptationSets:Ljava/util/List;

    # getter for: Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;->adaptationSetIndex:I
    invoke-static {p4}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;->access$500(Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;)I
    ...
    iget-object v7, v0, Lorg/telegram/messenger/exoplayer/dash/mpd/AdaptationSet;->representations:Ljava/util/List;

    iget-wide v2, v1, Lorg/telegram/messenger/exoplayer/dash/mpd/Period;->startMs:J
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->drmInitData:Lorg/telegram/messenger/exoplayer/drm/DrmInitData;

    invoke-virtual {p4}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;->isAdaptive()Z
    ...
    invoke-static {p4}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;->access$100(Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;)Lorg/telegram/messenger/exoplayer/chunk/Format;

    move-result-object v2

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer/chunk/Format;->id:Ljava/lang/String;

    invoke-static {v7, v2}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->getRepresentationIndex(Ljava/util/List;Ljava/lang/String;)I

    move-result v2

    aput v2, v0, v1

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->representationIndices:[I
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->representationHolders:Ljava/util/HashMap;

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->representationIndices:[I
    ...
    invoke-static {p4}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;->access$000(Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;)[Lorg/telegram/messenger/exoplayer/chunk/Format;
    ...
    :cond_2
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->representationIndices:[I
    ...
    check-cast v0, Lorg/telegram/messenger/exoplayer/dash/mpd/Representation;

    invoke-direct {p0, v4, v5, v0}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->updateRepresentationIndependentProperties(JLorg/telegram/messenger/exoplayer/dash/mpd/Representation;)V
...
.method private static getDrmInitData(Lorg/telegram/messenger/exoplayer/dash/mpd/AdaptationSet;)Lorg/telegram/messenger/exoplayer/drm/DrmInitData;
    ...
    iget-object v0, v0, Lorg/telegram/messenger/exoplayer/dash/mpd/ContentProtection;->data:Lorg/telegram/messenger/exoplayer/drm/DrmInitData$SchemeInitData;

    invoke-virtual {v1, v3, v0}, Lorg/telegram/messenger/exoplayer/drm/DrmInitData$Mapped;->put(Ljava/util/UUID;Lorg/telegram/messenger/exoplayer/drm/DrmInitData$SchemeInitData;)V
...
.method private static getRepresentationIndex(Ljava/util/List;Ljava/lang/String;)I
    ...
    iget-object v0, v0, Lorg/telegram/messenger/exoplayer/chunk/Format;->id:Ljava/lang/String;
...
.method private updateRepresentationIndependentProperties(JLorg/telegram/messenger/exoplayer/dash/mpd/Representation;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->indexIsUnbounded:Z

    invoke-interface {v2}, Lorg/telegram/messenger/exoplayer/dash/DashSegmentIndex;->isExplicit()Z

    move-result v0

    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->indexIsExplicit:Z

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->startTimeUs:J
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->availableStartTimeUs:J
    ...
    invoke-interface {v2, v4}, Lorg/telegram/messenger/exoplayer/dash/DashSegmentIndex;->getTimeUs(I)J

    move-result-wide v6

    add-long/2addr v0, v6

    invoke-interface {v2, v4, p1, p2}, Lorg/telegram/messenger/exoplayer/dash/DashSegmentIndex;->getDurationUs(IJ)J

    move-result-wide v2

    add-long/2addr v0, v2

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->availableEndTimeUs:J
    ...
    :cond_2
    iput-boolean v1, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->indexIsUnbounded:Z
...
.method public updatePeriod(Lorg/telegram/messenger/exoplayer/dash/mpd/MediaPresentationDescription;ILorg/telegram/messenger/exoplayer/dash/DashChunkSource$ExposedTrack;)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$PeriodHolder;->representationHolders:Ljava/util/HashMap;

    iget-object v7, v0, Lorg/telegram/messenger/exoplayer/dash/mpd/Representation;->format:Lorg/telegram/messenger/exoplayer/chunk/Format;
    ...
    invoke-virtual {v1, v4, v5, v0}, Lorg/telegram/messenger/exoplayer/dash/DashChunkSource$RepresentationHolder;->updateRepresentation(JLorg/telegram/messenger/exoplayer/dash/mpd/Representation;)V
