...
.method private flushTileCache(I)V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/util/AsyncListUtil$DataCallback;->getMaxCachedTiles()I

    move-result v0

    :goto_0
    iget-object v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mLoadedTiles:Landroid/util/SparseBooleanArray;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mLoadedTiles:Landroid/util/SparseBooleanArray;

    iget-object v3, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mLoadedTiles:Landroid/util/SparseBooleanArray;
    ...
    iget v3, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mFirstRequiredTileStart:I

    sub-int/2addr v3, v1

    iget v4, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mLastRequiredTileStart:I
    ...
    :cond_0
    invoke-direct {p0, v1}, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->removeTile(I)V
...
.method private requestTiles(IIIZ)V
    ...
    invoke-interface {v2, v0, p3}, Lorg/telegram/messenger/support/util/ThreadUtil$BackgroundCallback;->loadTile(II)V
...
.method public updateRange(IIIII)V
    ...
    iget v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mFirstRequiredTileStart:I

    invoke-direct {p0, v0, v1, p5, v3}, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    iget v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mLastRequiredTileStart:I

    invoke-direct {p0, v0, v1, p5, v4}, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    iget v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->mFirstRequiredTileStart:I
    ...
    invoke-direct {p0, v1, v0, p5, v3}, Lorg/telegram/messenger/support/util/AsyncListUtil$2;->requestTiles(IIIZ)V
