...
.method private recycleAllTiles()V
    ...
    iget-object v0, v0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTileList:Lorg/telegram/messenger/support/util/TileList;

    invoke-virtual {v0}, Lorg/telegram/messenger/support/util/TileList;->clear()V
...
.method public addTile(ILorg/telegram/messenger/support/util/TileList$Tile;)V
    ...
    iget-object v0, v0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mBackgroundProxy:Lorg/telegram/messenger/support/util/ThreadUtil$BackgroundCallback;

    invoke-interface {v0, p2}, Lorg/telegram/messenger/support/util/ThreadUtil$BackgroundCallback;->recycleTile(Lorg/telegram/messenger/support/util/TileList$Tile;)V
    ...
    invoke-virtual {v0, p2}, Lorg/telegram/messenger/support/util/TileList;->addOrReplace(Lorg/telegram/messenger/support/util/TileList$Tile;)Lorg/telegram/messenger/support/util/TileList$Tile;
    ...
    :cond_2
    iget v0, p2, Lorg/telegram/messenger/support/util/TileList$Tile;->mStartPosition:I

    iget v1, p2, Lorg/telegram/messenger/support/util/TileList$Tile;->mItemCount:I
    ...
    iget-object v2, v2, Lorg/telegram/messenger/support/util/AsyncListUtil;->mMissingPositions:Landroid/util/SparseIntArray;
    ...
    iget v3, p2, Lorg/telegram/messenger/support/util/TileList$Tile;->mStartPosition:I

    if-gt v3, v2, :cond_3

    if-ge v2, v1, :cond_3

    iget-object v3, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$1;->this$0:Lorg/telegram/messenger/support/util/AsyncListUtil;

    iget-object v3, v3, Lorg/telegram/messenger/support/util/AsyncListUtil;->mMissingPositions:Landroid/util/SparseIntArray;

    invoke-virtual {v3, v0}, Landroid/util/SparseIntArray;->removeAt(I)V

    iget-object v3, p0, Lorg/telegram/messenger/support/util/AsyncListUtil$1;->this$0:Lorg/telegram/messenger/support/util/AsyncListUtil;

    iget-object v3, v3, Lorg/telegram/messenger/support/util/AsyncListUtil;->mViewCallback:Lorg/telegram/messenger/support/util/AsyncListUtil$ViewCallback;

    invoke-virtual {v3, v2}, Lorg/telegram/messenger/support/util/AsyncListUtil$ViewCallback;->onItemLoaded(I)V
...
.method public removeTile(II)V
    ...
    invoke-virtual {v0, p2}, Lorg/telegram/messenger/support/util/TileList;->removeAtPos(I)Lorg/telegram/messenger/support/util/TileList$Tile;
