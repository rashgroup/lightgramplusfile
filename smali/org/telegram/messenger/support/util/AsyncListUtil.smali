...
.method public constructor <init>(Ljava/lang/Class;ILorg/telegram/messenger/support/util/AsyncListUtil$DataCallback;Lorg/telegram/messenger/support/util/AsyncListUtil$ViewCallback;)V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTmpRange:[I

    new-array v0, v2, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mPrevRange:[I

    new-array v0, v2, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTmpRangeExtended:[I

    iput v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mScrollHint:I

    iput v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mItemCount:I

    iput v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mDisplayedGeneration:I

    iget v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mDisplayedGeneration:I

    iput v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mRequestedGeneration:I

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mMissingPositions:Landroid/util/SparseIntArray;

    new-instance v0, Lorg/telegram/messenger/support/util/AsyncListUtil$1;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/util/AsyncListUtil$1;-><init>(Lorg/telegram/messenger/support/util/AsyncListUtil;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mMainThreadCallback:Lorg/telegram/messenger/support/util/ThreadUtil$MainThreadCallback;

    new-instance v0, Lorg/telegram/messenger/support/util/AsyncListUtil$2;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/util/AsyncListUtil$2;-><init>(Lorg/telegram/messenger/support/util/AsyncListUtil;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mBackgroundCallback:Lorg/telegram/messenger/support/util/ThreadUtil$BackgroundCallback;
    ...
    new-instance v0, Lorg/telegram/messenger/support/util/TileList;

    iget v1, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTileSize:I

    invoke-direct {v0, v1}, Lorg/telegram/messenger/support/util/TileList;-><init>(I)V

    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTileList:Lorg/telegram/messenger/support/util/TileList;
    ...
    iput-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mBackgroundProxy:Lorg/telegram/messenger/support/util/ThreadUtil$BackgroundCallback;
...
.method public getItem(I)Ljava/lang/Object;
    ...
    iget v2, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mItemCount:I
    ...
    :cond_1
    iget-object v0, p0, Lorg/telegram/messenger/support/util/AsyncListUtil;->mTileList:Lorg/telegram/messenger/support/util/TileList;

    invoke-virtual {v0, p1}, Lorg/telegram/messenger/support/util/TileList;->getItemAt(I)Ljava/lang/Object;
