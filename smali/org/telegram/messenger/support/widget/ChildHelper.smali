.class Lorg/telegram/messenger/support/widget/ChildHelper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/telegram/messenger/support/widget/ChildHelper$Callback;,
        Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;
    }
.end annotation
...
# instance fields
.field final mBucket:Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;

.field final mCallback:Lorg/telegram/messenger/support/widget/ChildHelper$Callback;
...
# direct methods
.method constructor <init>(Lorg/telegram/messenger/support/widget/ChildHelper$Callback;)V
    .locals 1
...
.method private getOffset(I)I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/ChildHelper;->mBucket:Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;

    invoke-virtual {v3, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;->countOnesBefore(I)I
    ...
    invoke-virtual {v1, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;->get(I)Z
...
.method findHiddenNonRemovedView(I)Landroid/view/View;
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/ChildHelper;->mCallback:Lorg/telegram/messenger/support/widget/ChildHelper$Callback;

    invoke-interface {v3, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->getChildViewHolder(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
...
.method getChildAt(I)Landroid/view/View;
    ...
    invoke-interface {v1, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
...
.method hide(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->indexOfChild(Landroid/view/View;)I
...
.method indexOfChild(Landroid/view/View;)I
    ...
    invoke-virtual {v2, v1}, Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;->get(I)Z

    move-result v2

    if-nez v2, :cond_0

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/ChildHelper;->mBucket:Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;

    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;->countOnesBefore(I)I
...
.method removeAllViewsUnfiltered()V
    ...
    invoke-interface {v2, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->removeAllViews()V
...
.method removeView(Landroid/view/View;)V
    ...
    invoke-interface {v1, v0}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->removeViewAt(I)V
...
.method removeViewIfHidden(Landroid/view/View;)Z
    ...
    invoke-virtual {v2, v1}, Lorg/telegram/messenger/support/widget/ChildHelper$Bucket;->remove(I)Z
    ...
    invoke-interface {v2, v1}, Lorg/telegram/messenger/support/widget/ChildHelper$Callback;->removeViewAt(I)V
