...
.method private applyRemove(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
    ...
    iget v7, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I

    iget v0, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    iget v3, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    invoke-interface {v0, v3}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->findViewHolder(I)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-direct {p0, v3}, Lorg/telegram/messenger/support/widget/AdapterHelper;->canFindInPreLayout(I)Z
    ...
    invoke-virtual {p0, v8, v7, v6, v9}, Lorg/telegram/messenger/support/widget/AdapterHelper;->obtainUpdateOp(IIILjava/lang/Object;)Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;
    ...
    :cond_3
    iget v0, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
...
.method private applyUpdate(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-object v7, p0, Lorg/telegram/messenger/support/widget/AdapterHelper;->mCallback:Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;

    invoke-interface {v7, v3}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->findViewHolder(I)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget-object v5, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->payload:Ljava/lang/Object;

    invoke-virtual {p0, v8, v2, v0, v5}, Lorg/telegram/messenger/support/widget/AdapterHelper;->obtainUpdateOp(IIILjava/lang/Object;)Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;
    ...
    invoke-virtual {p0, v8, v2, v0, v1}, Lorg/telegram/messenger/support/widget/AdapterHelper;->obtainUpdateOp(IIILjava/lang/Object;)Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;
...
.method private canFindInPreLayout(I)Z
    ...
    iget v5, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    const/16 v6, 0x8

    if-ne v5, v6, :cond_0

    iget v0, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I

    add-int/lit8 v5, v3, 0x1

    invoke-virtual {p0, v0, v5}, Lorg/telegram/messenger/support/widget/AdapterHelper;->findPositionOffset(II)I
    ...
    iget v6, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I

    add-int/2addr v5, v6

    iget v0, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    invoke-virtual {p0, v0, v6}, Lorg/telegram/messenger/support/widget/AdapterHelper;->findPositionOffset(II)I
...
.method private dispatchAndUpdateViewHolders(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
    ...
    iget v3, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    invoke-direct {p0, v0, v3}, Lorg/telegram/messenger/support/widget/AdapterHelper;->updatePositionWithPostponed(II)I
    ...
    :goto_1
    iget v7, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
    ...
    iget v8, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    invoke-direct {p0, v7, v8}, Lorg/telegram/messenger/support/widget/AdapterHelper;->updatePositionWithPostponed(II)I

    move-result v8

    iget v7, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I
    ...
    iget-object v9, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->payload:Ljava/lang/Object;

    invoke-virtual {p0, v7, v6, v5, v9}, Lorg/telegram/messenger/support/widget/AdapterHelper;->obtainUpdateOp(IIILjava/lang/Object;)Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;

    move-result-object v6

    invoke-virtual {p0, v6, v4}, Lorg/telegram/messenger/support/widget/AdapterHelper;->dispatchFirstPassAndUpdateViewHolders(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;I)V
    ...
    iget v6, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I
    ...
    :cond_6
    iget-object v0, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->payload:Ljava/lang/Object;

    invoke-virtual {p0, p1}, Lorg/telegram/messenger/support/widget/AdapterHelper;->recycleUpdateOp(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V

    if-lez v5, :cond_7

    iget v1, p1, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    invoke-virtual {p0, v1, v6, v5, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->obtainUpdateOp(IIILjava/lang/Object;)Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;

    move-result-object v0

    invoke-virtual {p0, v0, v4}, Lorg/telegram/messenger/support/widget/AdapterHelper;->dispatchFirstPassAndUpdateViewHolders(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;I)V

    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->recycleUpdateOp(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
...
.method private updatePositionWithPostponed(II)I
    ...
    iget v2, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    if-ne v2, v7, :cond_a

    iget v2, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I

    iget v3, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I

    if-ge v2, v3, :cond_2

    iget v3, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I

    iget v2, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
    ...
    iput v2, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
    ...
    iput v2, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    iget v3, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I

    if-ne v3, v7, :cond_11

    iget v3, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I

    iget v4, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->positionStart:I
...
.method public applyPendingUpdatesToPosition(I)I
    ...
    iget v4, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->cmd:I
    ...
    iget v1, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
...
.method consumePostponedUpdates()V
    ...
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/AdapterHelper;->mCallback:Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;
    ...
    invoke-interface {v4, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->onDispatchSecondPass(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
...
.method consumeUpdatesInOnePass()V
    ...
    :goto_1
    :pswitch_0
    iget-object v0, p0, Lorg/telegram/messenger/support/widget/AdapterHelper;->mOnItemProcessedCallback:Ljava/lang/Runnable;
    ...
    invoke-interface {v4, v5, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->offsetPositionsForAdd(II)V
    ...
    invoke-interface {v4, v5, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->offsetPositionsForRemovingInvisible(II)V
    ...
    iget-object v0, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->payload:Ljava/lang/Object;

    invoke-interface {v4, v5, v6, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->markViewHoldersUpdated(IILjava/lang/Object;)V
    ...
    invoke-interface {v4, v5, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper$Callback;->offsetPositionsForMove(II)V
...
.method findPositionOffset(II)I
    ...
    iget v4, v0, Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;->itemCount:I
...
.method preProcess()V
    ...
    iget-object v0, p0, Lorg/telegram/messenger/support/widget/AdapterHelper;->mOpReorderer:Lorg/telegram/messenger/support/widget/OpReorderer;

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/AdapterHelper;->mPendingUpdates:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/OpReorderer;->reorderOps(Ljava/util/List;)V
    ...
    :pswitch_1
    invoke-direct {p0, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->applyAdd(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :pswitch_2
    invoke-direct {p0, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->applyRemove(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :pswitch_3
    invoke-direct {p0, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->applyUpdate(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :pswitch_4
    invoke-direct {p0, v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->applyMove(Lorg/telegram/messenger/support/widget/AdapterHelper$UpdateOp;)V
