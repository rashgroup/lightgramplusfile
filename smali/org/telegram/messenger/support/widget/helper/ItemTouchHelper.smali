...
.method private checkHorizontalSwipe(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)I
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDx:F
    ...
    :goto_0
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mVelocityTracker:Landroid/view/VelocityTracker;

    if-eqz v3, :cond_2

    iget v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActivePointerId:I
    ...
    iget-object v5, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    iget v6, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mMaxSwipeVelocity:F

    invoke-virtual {v5, v6}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getSwipeVelocityThreshold(F)F
    ...
    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActivePointerId:I

    invoke-static {v3, v4}, Landroid/support/v4/view/VelocityTrackerCompat;->getXVelocity(Landroid/view/VelocityTracker;I)F

    move-result v3

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mVelocityTracker:Landroid/view/VelocityTracker;

    iget v5, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActivePointerId:I
    ...
    iget v5, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSwipeEscapeVelocity:F

    invoke-virtual {v3, v5}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getSwipeEscapeVelocity(F)F
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->getWidth()I

    move-result v1

    int-to-float v1, v1

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    invoke-virtual {v2, p1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getSwipeThreshold(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)F
...
.method private checkVerticalSwipe(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)I
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDy:F
    ...
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    iget v5, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSwipeEscapeVelocity:F

    invoke-virtual {v4, v5}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getSwipeEscapeVelocity(F)F
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->getHeight()I
...
.method private destroyCallbacks()V
    ...
    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->removeItemDecoration(Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mOnItemTouchListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;

    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->removeOnItemTouchListener(Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->removeOnChildAttachStateChangeListener(Lorg/telegram/messenger/support/widget/RecyclerView$OnChildAttachStateChangeListener;)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecoverAnimations:Ljava/util/List;
    ...
    invoke-virtual {v2, v3, v0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->clearView(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mOverdrawChild:Landroid/view/View;
...
.method private findSwapTargets(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Ljava/util/List;
    ...
    iget-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSwapTargets:Ljava/util/List;
    ...
    iput-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSwapTargets:Ljava/util/List;
    ...
    iput-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDistances:Ljava/util/List;

    :goto_0
    move-object/from16 v0, p0

    iget-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getBoundingBoxMargin()I

    move-result v1

    move-object/from16 v0, p0

    iget v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartX:F

    move-object/from16 v0, p0

    iget v3, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDx:F
    ...
    iget v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartY:F

    move-object/from16 v0, p0

    iget v3, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDy:F
    ...
    iget-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    invoke-virtual {v11}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getChildCount()I
    ...
    invoke-virtual {v11, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getChildAt(I)Landroid/view/View;
    ...
    iget-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDistances:Ljava/util/List;
    ...
    iget-object v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v2, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    move-result-object v13

    move-object/from16 v0, p0

    iget-object v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    move-object/from16 v0, p0

    iget-object v3, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    invoke-virtual {v2, v3, v14, v13}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->canDropOver(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Z
...
.method private findSwipedView(Landroid/view/MotionEvent;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActivePointerId:I
    ...
    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mInitialTouchX:F
    ...
    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mInitialTouchY:F
    ...
    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSlop:I
...
.method private setupCallbacks()V
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSlop:I

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->addItemDecoration(Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mOnItemTouchListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;

    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->addOnItemTouchListener(Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->addOnChildAttachStateChangeListener(Lorg/telegram/messenger/support/widget/RecyclerView$OnChildAttachStateChangeListener;)V
...
.method private swipeIfNecessary(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    iget v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActionState:I
    ...
    invoke-virtual {v1, v2, p1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getMovementFlags(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    invoke-virtual {v2, v1, v3}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->convertToAbsoluteDirection(II)I
    ...
    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDy:F
    ...
    invoke-direct {p0, p1, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->checkHorizontalSwipe(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)I
    ...
    invoke-static {v1, v0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->convertToRelativeDirection(II)I
    ...
    :cond_3
    invoke-direct {p0, p1, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->checkVerticalSwipe(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)I
...
.method public attachToRecyclerView(Lorg/telegram/messenger/support/widget/RecyclerView;)V
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSwipeEscapeVelocity:F
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mMaxSwipeVelocity:F
...
.method checkSelectForSwipe(ILandroid/view/MotionEvent;I)Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelected:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    if-nez v2, :cond_0

    if-ne p1, v3, :cond_0

    iget v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActionState:I

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->isItemViewSwipeEnabled()Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->getScrollState()I
    ...
    invoke-virtual {v3, v4, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getAbsoluteMovementFlags(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    iget v6, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mInitialTouchX:F

    sub-float/2addr v4, v6

    iget v6, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mInitialTouchY:F
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActivePointerId:I

    invoke-virtual {p0, v2, v1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->select(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)V
...
.method endRecoverAnimation(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Z)I
    ...
    iget-object v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mViewHolder:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    if-ne v2, p1, :cond_1

    iget-boolean v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mOverridden:Z

    or-int/2addr v2, p2

    iput-boolean v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mOverridden:Z

    iget-boolean v2, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mEnded:Z
    ...
    iget v0, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mAnimationType:I
...
.method findChildView(Landroid/view/MotionEvent;)Landroid/view/View;
    ...
    iget v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartX:F

    iget v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDx:F

    add-float/2addr v1, v2

    iget v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartY:F

    iget v5, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDy:F

    add-float/2addr v2, v5

    invoke-static {v0, v3, v4, v1, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->hitTest(Landroid/view/View;FFFF)Z
    ...
    iget-object v1, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mViewHolder:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    iget-object v1, v1, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    iget v5, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mX:F

    iget v0, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mY:F

    invoke-static {v1, v3, v4, v5, v0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->hitTest(Landroid/view/View;FFFF)Z
...
.method hasRunningRecoverAnim()Z
    ...
    iget-boolean v0, v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->mEnded:Z
...
.method moveIfNecessary(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    iget v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartY:F
    ...
    invoke-virtual {v1, p1, v0, v6, v7}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->chooseDropTarget(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Ljava/util/List;II)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
...
.method public onChildViewDetachedFromWindow(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, v0, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->select(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)V
...
.method scrollIfNecessary()Z
    ...
    iput-wide v12, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDragScrollStartTimeInMs:J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDragScrollStartTimeInMs:J
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;

    :cond_1
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelected:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    iget-object v2, v2, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;

    invoke-virtual {v1, v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->calculateItemDecorationsForChild(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget v2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartX:F

    iget v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDx:F
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->getPaddingLeft()I
    ...
    invoke-virtual {v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->getPaddingTop()I
    ...
    invoke-virtual {v5}, Lorg/telegram/messenger/support/widget/RecyclerView;->getWidth()I

    move-result v5

    invoke-virtual/range {v1 .. v7}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->interpolateOutOfBoundsScroll(Lorg/telegram/messenger/support/widget/RecyclerView;IIIJ)I
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->getHeight()I
    ...
    iput-wide v10, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDragScrollStartTimeInMs:J

    :cond_5
    iget-object v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v0, v9, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->scrollBy(II)V
    ...
    invoke-virtual {v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->getWidth()I

    move-result v3

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->getPaddingRight()I
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->getHeight()I

    move-result v2

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->getPaddingBottom()I
...
.method select(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)V
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mDragScrollStartTimeInMs:J

    iget v4, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActionState:I

    const/4 v0, 0x1

    invoke-virtual {p0, p1, v0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->endRecoverAnimation(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Z)I

    iput p2, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mActionState:I
    ...
    invoke-direct {p0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->addChildDrawingOrderCallback()V
    ...
    new-instance v0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$3;

    move-object v1, p0

    move-object v10, v2

    invoke-direct/range {v0 .. v10}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$3;-><init>(Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;IIFFFFILorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getAnimationDuration(Lorg/telegram/messenger/support/widget/RecyclerView;IFF)J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->setDuration(J)V

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecoverAnimations:Ljava/util/List;

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$RecoverAnimation;->start()V
    ...
    invoke-virtual {v0, v2, p1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->getAbsoluteMovementFlags(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedFlags:I
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartX:F
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelectedStartY:F

    iput-object p1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mSelected:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->requestSimpleAnimationsInNextLayout()V
    ...
    invoke-virtual {v0, v1, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->onSelectedChanged(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;I)V
    ...
    :cond_6
    invoke-direct {p0, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->swipeIfNecessary(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    invoke-virtual {p0, v1}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->removeChildDrawingOrderCallbackIfNecessary(Landroid/view/View;)V

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mCallback:Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mRecyclerView:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v1, v3, v2}, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper$Callback;->clearView(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
...
.method updateDxDy(Landroid/view/MotionEvent;II)V
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/helper/ItemTouchHelper;->mInitialTouchY:F
