.class public Lorg/telegram/messenger/support/widget/LinearSmoothScroller;
...
.method public calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    invoke-virtual {v4, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getDecoratedLeft(Landroid/view/View;)I
    ...
    invoke-virtual {v4, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getDecoratedRight(Landroid/view/View;)I

    move-result v2

    iget v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->rightMargin:I

    add-int/2addr v2, v0

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getPaddingLeft()I

    move-result v3

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getWidth()I

    move-result v0

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getPaddingRight()I
...
.method public calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {v4, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getDecoratedTop(Landroid/view/View;)I
    ...
    invoke-virtual {v4, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getDecoratedBottom(Landroid/view/View;)I
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getPaddingTop()I

    move-result v3

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getHeight()I

    move-result v0

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getPaddingBottom()I
...
.method public computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    const-class v2, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$ScrollVectorProvider;
...
.method protected onTargetFound(Landroid/view/View;Lorg/telegram/messenger/support/widget/RecyclerView$State;Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {p0, p1, v0}, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, p1, v1}, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, v2}, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->calculateTimeForDeceleration(I)I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {p3, v0, v1, v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->update(IIILandroid/view/animation/Interpolator;)V
...
.method protected updateActionForInterimTarget(Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {p1, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->jumpTo(I)V
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->calculateTimeForScrolling(I)I

    move-result v0

    iget v1, p0, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->mInterimTargetDx:I
    ...
    iget v2, p0, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->mInterimTargetDy:I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/LinearSmoothScroller;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;

    invoke-virtual {p1, v1, v2, v0, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->update(IIILandroid/view/animation/Interpolator;)V
