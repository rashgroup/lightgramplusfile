...
.method private computeScrollDuration(IIII)I
    ...
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    invoke-direct {p0, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->distanceInfluenceForSnapDuration(F)F
...
.method public run()V
    ...
    invoke-virtual {p0}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->stop()V

    :goto_0
    return-void

    :cond_0
    invoke-direct {p0}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->disableRunOnAnimationRequests()V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->consumePendingUpdateOperations()V

    iget-object v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/support/v4/widget/ScrollerCompat;

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    iget-object v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayout:Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    iget-object v8, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->mSmoothScroller:Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->mLastFlingX:I

    sub-int v11, v9, v0

    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->mLastFlingY:I
    ...
    iput v9, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->mLastFlingX:I

    iput v10, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->mLastFlingY:I

    const/4 v2, 0x0

    const/4 v0, 0x0

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->eatRequestLayout()V

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->onEnterLayoutOrScroll()V
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    iget-object v3, v3, Lorg/telegram/messenger/support/widget/RecyclerView;->mRecycler:Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;
    ...
    invoke-virtual {v2, v11, v3, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->scrollHorizontallyBy(ILorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v0, v12, v1, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->scrollVerticallyBy(ILorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->repositionShadowingViews()V

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->onExitLayoutOrScroll()V

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lorg/telegram/messenger/support/widget/RecyclerView;->resumeRequestLayout(Z)V

    if-eqz v8, :cond_16

    invoke-virtual {v8}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->isPendingInitialRun()Z

    move-result v4

    if-nez v4, :cond_16

    invoke-virtual {v8}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->isRunning()Z
    ...
    invoke-virtual {v8}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->stop()V
    ...
    iget-object v4, v4, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemDecorations:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->getOverScrollMode()I
    ...
    invoke-virtual {v4, v11, v12}, Lorg/telegram/messenger/support/widget/RecyclerView;->considerReleasingGlowsOnScroll(II)V
    ...
    invoke-virtual {v4, v6, v5}, Lorg/telegram/messenger/support/widget/RecyclerView;->absorbGlows(II)V
    ...
    invoke-virtual {v0, v3, v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchOnScrolled(II)V

    :cond_c
    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->this$0:Lorg/telegram/messenger/support/widget/RecyclerView;

    # invokes: Lorg/telegram/messenger/support/widget/RecyclerView;->awakenScrollBars()Z
    invoke-static {v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->access$500(Lorg/telegram/messenger/support/widget/RecyclerView;)Z
    ...
    invoke-static {v8, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->access$400(Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;II)V
    ...
    :cond_13
    invoke-direct {p0}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->enableRunOnAnimationRequests()V

    goto/16 :goto_0

    :cond_14
    invoke-virtual {v8}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->getTargetPosition()I
    ...
    invoke-virtual {v8, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->setTargetPosition(I)V
    ...
    # invokes: Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->onAnimation(II)V
    invoke-static {v8, v4, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;->access$400(Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller;II)V
    ...
    invoke-virtual {v0, v1, v11, v12}, Lorg/telegram/messenger/support/widget/GapWorker;->postFromTraversal(Lorg/telegram/messenger/support/widget/RecyclerView;II)V
