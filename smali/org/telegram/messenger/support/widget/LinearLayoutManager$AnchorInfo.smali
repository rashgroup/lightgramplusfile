...
.method public assignFromViewAndKeepVisibleRect(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getTotalSpaceChange()I

    move-result v0

    if-ltz v0, :cond_1

    invoke-virtual {p0, p1}, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->assignFromView(Landroid/view/View;)V
    ...
    invoke-virtual {v1, p1}, Lorg/telegram/messenger/support/widget/LinearLayoutManager;->getPosition(Landroid/view/View;)I

    move-result v1

    iput v1, p0, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->mPosition:I
    ...
    invoke-virtual {v1, p1}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getDecoratedEnd(Landroid/view/View;)I
    ...
    iput v1, p0, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->mCoordinate:I
    ...
    iget v2, p0, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->mCoordinate:I

    sub-int v1, v2, v1

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->this$0:Lorg/telegram/messenger/support/widget/LinearLayoutManager;

    iget-object v2, v2, Lorg/telegram/messenger/support/widget/LinearLayoutManager;->mOrientationHelper:Lorg/telegram/messenger/support/widget/OrientationHelper;

    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getStartAfterPadding()I

    move-result v2

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/LinearLayoutManager$AnchorInfo;->this$0:Lorg/telegram/messenger/support/widget/LinearLayoutManager;

    iget-object v3, v3, Lorg/telegram/messenger/support/widget/LinearLayoutManager;->mOrientationHelper:Lorg/telegram/messenger/support/widget/OrientationHelper;

    invoke-virtual {v3, p1}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getDecoratedStart(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p1}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getDecoratedStart(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getDecoratedMeasurement(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Lorg/telegram/messenger/support/widget/OrientationHelper;->getDecoratedEnd(Landroid/view/View;)I
