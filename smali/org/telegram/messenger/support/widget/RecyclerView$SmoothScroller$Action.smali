...
.method runIfNecessary(Lorg/telegram/messenger/support/widget/RecyclerView;)V
    ...
    iput-boolean v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->changed:Z

    :goto_0
    return-void

    :cond_0
    iget-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->changed:Z
    ...
    iget-object v0, p1, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewFlinger:Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;

    iget v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->mDx:I

    iget v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->mDy:I

    invoke-virtual {v0, v1, v2}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->smoothScrollBy(II)V

    :goto_1
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->consecutiveUpdates:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->consecutiveUpdates:I
    ...
    iget v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->mDuration:I

    invoke-virtual {v0, v1, v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->smoothScrollBy(III)V
    ...
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->mInterpolator:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v1, v2, v3, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->smoothScrollBy(IIILandroid/view/animation/Interpolator;)V

    goto :goto_1

    :cond_4
    iput v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView$SmoothScroller$Action;->consecutiveUpdates:I
