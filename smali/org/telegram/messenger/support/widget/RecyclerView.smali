...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$RecyclerViewDataObserver;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$RecyclerViewDataObserver;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mObserver:Lorg/telegram/messenger/support/widget/RecyclerView$RecyclerViewDataObserver;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mRecycler:Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;

    new-instance v0, Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-direct {v0}, Lorg/telegram/messenger/support/widget/ViewInfoStore;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$1;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$1;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mUpdateChildViewsRunnable:Ljava/lang/Runnable;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTempRect:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTempRect2:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTempRectF:Landroid/graphics/RectF;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemDecorations:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mOnItemTouchListeners:Ljava/util/ArrayList;

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mEatRequestLayout:I

    iput-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDataSetHasChangedAfterLayout:Z

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayoutOrScrollCounter:I

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDispatchScrollCounter:I

    new-instance v0, Lorg/telegram/messenger/support/widget/DefaultItemAnimator;

    invoke-direct {v0}, Lorg/telegram/messenger/support/widget/DefaultItemAnimator;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimator:Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollState:I

    const/4 v0, -0x1

    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollPointerId:I

    const/4 v0, 0x1

    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollFactor:F

    iput-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mPreserveFocusAfterLayout:Z

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewFlinger:Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;

    sget-boolean v0, Lorg/telegram/messenger/support/widget/RecyclerView;->ALLOW_THREAD_GAP_WORK:Z

    if-eqz v0, :cond_1

    new-instance v0, Lorg/telegram/messenger/support/widget/GapWorker$LayoutPrefetchRegistryImpl;

    invoke-direct {v0}, Lorg/telegram/messenger/support/widget/GapWorker$LayoutPrefetchRegistryImpl;-><init>()V

    :goto_0
    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mPrefetchRegistry:Lorg/telegram/messenger/support/widget/GapWorker$LayoutPrefetchRegistryImpl;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;

    invoke-direct {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$State;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsAddedOrRemoved:Z

    iput-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsChanged:Z

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimatorRestoreListener;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimatorRestoreListener;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimatorListener:Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;

    iput-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mPostedAnimatorRunner:Z

    new-array v0, v4, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMinMaxLayoutPositions:[I

    new-array v0, v4, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I

    new-array v0, v4, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollConsumed:[I

    new-array v0, v4, [I

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->topGlowOffset:I

    iput v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->glowColor:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mPendingAccessibilityImportanceChange:Ljava/util/List;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$2;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$2;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimatorRunner:Ljava/lang/Runnable;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerView$4;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$4;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoProcessCallback:Lorg/telegram/messenger/support/widget/ViewInfoStore$ProcessCallback;

    if-eqz p2, :cond_2

    sget-object v0, Lorg/telegram/messenger/support/widget/RecyclerView;->CLIP_TO_PADDING_ATTR:[I
    ...
    :goto_1
    invoke-virtual {p0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->setScrollContainer(Z)V

    invoke-virtual {p0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->setFocusableInTouchMode(Z)V
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMaxFlingVelocity:I
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimatorListener:Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;

    invoke-virtual {v0, v2}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;->setListener(Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;)V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;

    new-instance v0, Lorg/telegram/messenger/support/widget/RecyclerViewAccessibilityDelegate;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerViewAccessibilityDelegate;-><init>(Lorg/telegram/messenger/support/widget/RecyclerView;)V

    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->setAccessibilityDelegateCompat(Lorg/telegram/messenger/support/widget/RecyclerViewAccessibilityDelegate;)V

    const/high16 v0, 0x40000

    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->setDescendantFocusability(I)V
    ...
    :cond_2
    iput-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mClipToPadding:Z
...
.method private addAnimatingView(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v0, v2, v3, v4, v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {v0, v2, v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->addView(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/messenger/support/widget/ChildHelper;->hide(Landroid/view/View;)V
...
.method static clearNestedRecyclerViewIfNotNested(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    .locals 3
    .param p0    # Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    :cond_3
    iput-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method private createLayoutManager(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->getFullClassName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v1, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;
    ...
    :try_start_1
    sget-object v0, Lorg/telegram/messenger/support/widget/RecyclerView;->LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE:[Ljava/lang/Class;
    ...
    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->setLayoutManager(Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;)V
...
.method private dispatchContentChangedIfNecessary()V
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mEatenAccessibilityChangeFlags:I
    ...
    invoke-virtual {p0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->sendAccessibilityEventUnchecked(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method private dispatchLayoutStep1()V
    ...
    invoke-virtual {v2, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$State;->assertLayoutStep(I)V

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v1, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mIsMeasuring:Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->clear()V
    ...
    iget-boolean v3, v3, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mRunSimpleAnimations:Z
    ...
    :goto_0
    iput-boolean v0, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mTrackOldChangeHolders:Z

    iput-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsChanged:Z

    iput-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsAddedOrRemoved:Z
    ...
    iget-boolean v2, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mRunPredictiveAnimations:Z

    iput-boolean v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mInPreLayout:Z
    ...
    invoke-direct {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->findMinMaxChildLayoutPositions([I)V
    ...
    invoke-virtual {v3, v0}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
    ...
    :cond_2
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimator:Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;
    ...
    invoke-virtual {v4, v5, v3, v6, v7}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;->recordPreLayoutInformation(Lorg/telegram/messenger/support/widget/RecyclerView$State;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;ILjava/util/List;)Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    move-result-object v4

    iget-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v5, v3, v4}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToPreLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    iget-boolean v4, v4, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mTrackOldChangeHolders:Z

    if-eqz v4, :cond_0

    invoke-virtual {v3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->isUpdated()Z
    ...
    invoke-virtual {p0, v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->getChangedHolderKey(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)J

    move-result-wide v4

    iget-object v6, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v6, v4, v5, v3}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToOldChangeHolders(JLorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    iget-boolean v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mRunPredictiveAnimations:Z
    ...
    iget-boolean v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mStructureChanged:Z

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v1, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mStructureChanged:Z
    ...
    invoke-virtual {v2, v3, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onLayoutChildren(Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)V

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v0, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mStructureChanged:Z
    ...
    invoke-virtual {v2, v0}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v2, v3}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->isInPreLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Z
    ...
    invoke-virtual {v3, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->hasAnyOfTheFlags(I)Z
    ...
    :cond_6
    iget-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemAnimator:Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;
    ...
    invoke-virtual {v5, v6, v3, v2, v7}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;->recordPreLayoutInformation(Lorg/telegram/messenger/support/widget/RecyclerView$State;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;ILjava/util/List;)Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    move-result-object v2

    if-eqz v4, :cond_7

    invoke-virtual {p0, v3, v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V

    goto :goto_4

    :cond_7
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v4, v3, v2}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToAppearedInPreLayoutHolders(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    iput v1, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mLayoutStep:I
...
.method private dispatchLayoutStep3()V
    ...
    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$State;->assertLayoutStep(I)V
    ...
    iput v11, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mLayoutStep:I
    ...
    invoke-virtual {v0, v7}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v1, v2}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;->recordPostLayoutInformation(Lorg/telegram/messenger/support/widget/RecyclerView$State;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    move-result-object v0

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v1, v8, v9}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->getFromOldChangeHolders(J)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v3, v1}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->isDisappearing(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Z

    move-result v5

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v3, v2}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->isDisappearing(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Z
    ...
    invoke-virtual {v1, v2, v0}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToPostLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-virtual {v3, v1}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->popFromPreLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    move-result-object v3

    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoStore:Lorg/telegram/messenger/support/widget/ViewInfoStore;

    invoke-virtual {v4, v2, v0}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToPostLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-direct {p0, v8, v9, v2, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->handleMissingPreInfoForChangeError(JLorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewInfoProcessCallback:Lorg/telegram/messenger/support/widget/ViewInfoStore$ProcessCallback;

    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->process(Lorg/telegram/messenger/support/widget/ViewInfoStore$ProcessCallback;)V
    ...
    iget v1, v1, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mItemCount:I

    iput v1, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mPreviousLayoutItemCount:I

    iput-boolean v10, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDataSetHasChangedAfterLayout:Z

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v10, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mRunSimpleAnimations:Z

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v10, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mRunPredictiveAnimations:Z

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayout:Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    iput-boolean v10, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->mRequestedSimpleAnimations:Z
    ...
    iput v10, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->mPrefetchMaxCountObserved:I

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayout:Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    iput-boolean v10, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->mPrefetchMaxObservedInInitialPrefetch:Z
    ...
    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onLayoutCompleted(Lorg/telegram/messenger/support/widget/RecyclerView$State;)V

    invoke-virtual {p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->onExitLayoutOrScroll()V

    invoke-virtual {p0, v10}, Lorg/telegram/messenger/support/widget/RecyclerView;->resumeRequestLayout(Z)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMinMaxLayoutPositions:[I

    aget v1, v1, v11

    invoke-direct {p0, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->didChildRangeChange(II)Z

    move-result v0

    if-eqz v0, :cond_8

    invoke-virtual {p0, v10, v10}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchOnScrolled(II)V
...
.method private dispatchOnItemTouch(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mActiveOnItemTouchListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;
    ...
    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;

    invoke-interface {v0, p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;->onInterceptTouchEvent(Lorg/telegram/messenger/support/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mActiveOnItemTouchListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;

    invoke-interface {v2, p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;->onTouchEvent(Lorg/telegram/messenger/support/widget/RecyclerView;Landroid/view/MotionEvent;)V
...
.method private findMinMaxChildLayoutPositions([I)V
    ...
    invoke-virtual {v1, v3}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
...
.method static findNestedRecyclerView(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    :cond_0
    instance-of v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;
    ...
    invoke-static {v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->findNestedRecyclerView(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView;
...
.method private findNextViewToFocus()Landroid/view/View;
    ...
    iget v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mFocusedItemPosition:I
    ...
    invoke-virtual {p0, v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->findViewHolderForAdapterPosition(I)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    :cond_2
    iget-object v5, v4, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;
    ...
    iget-object v0, v4, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;
    ...
    iget-object v0, v2, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;
...
.method private getScrollFactor()F
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollFactor:F
...
.method private hasUpdatedView()Z
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildCount()I
    ...
    invoke-virtual {v3, v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
...
.method private isPreferredNextFocus(Landroid/view/View;Landroid/view/View;I)Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getLayoutDirection()I
...
.method private onPointerUp(Landroid/view/MotionEvent;)V
    ...
    iget v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollPointerId:I
    ...
    iput v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollPointerId:I
    ...
    iput v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLastTouchX:I

    iput v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchX:I
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchY:I
...
.method private processAdapterUpdatesAndSetAnimationFlags()V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/AdapterHelper;->reset()V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayout:Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onItemsChanged(Lorg/telegram/messenger/support/widget/RecyclerView;)V
    ...
    :goto_0
    iget-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsAddedOrRemoved:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemsChanged:Z
...
.method private pullGlows(FFFF)V
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLeftGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method private recoverFocusFromState()V
    ...
    sget-boolean v2, Lorg/telegram/messenger/support/widget/RecyclerView;->IGNORE_DETACHED_FOCUSED_CHILD:Z
    ...
    iget-wide v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mFocusedItemId:J
    ...
    invoke-virtual {p0, v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->findViewHolderForItemId(J)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mFocusedSubChildId:I
...
.method private saveFocusInfo()V
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mPreserveFocusAfterLayout:Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->findContainingViewHolder(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    :goto_3
    iput-wide v0, v3, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mFocusedItemId:J
    ...
    :goto_4
    iput v0, v1, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mFocusedItemPosition:I

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iget-object v1, v2, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    invoke-direct {p0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->getDeepestFocusedViewWithId(Landroid/view/View;)I
    ...
    iget v0, v2, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mOldPosition:I

    goto :goto_4

    :cond_4
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->getAdapterPosition()I
...
.method private setAdapterInternal(Lorg/telegram/messenger/support/widget/RecyclerView$Adapter;ZZ)V
    ...
    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/RecyclerView$Adapter;->onDetachedFromRecyclerView(Lorg/telegram/messenger/support/widget/RecyclerView;)V
...
.method applyEdgeEffectColor(Landroid/support/v4/widget/EdgeEffectCompat;)V
    ...
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->glowColor:I
    ...
    const-string/jumbo v1, "mEdgeEffect"
    ...
    iget v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->glowColor:I
...
.method clearOldPositions()V
    ...
    invoke-virtual {v2, v0}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->clearOldPositions()V
...
.method defaultOnMeasure(II)V
    ...
    invoke-static {p1, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->chooseSize(III)I
    ...
    invoke-static {p2, v1, v2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->chooseSize(III)I

    move-result v1

    invoke-virtual {p0, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->setMeasuredDimension(II)V
...
.method dispatchChildAttached(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Adapter;->onViewAttachedToWindow(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$OnChildAttachStateChangeListener;

    invoke-interface {v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnChildAttachStateChangeListener;->onChildViewAttachedToWindow(Landroid/view/View;)V
...
.method dispatchChildDetached(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Adapter;->onViewDetachedFromWindow(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-interface {v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnChildAttachStateChangeListener;->onChildViewDetachedFromWindow(Landroid/view/View;)V
...
.method dispatchOnScrollStateChanged(I)V
    ...
    invoke-virtual {v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onScrollStateChanged(I)V

    :cond_0
    invoke-virtual {p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->onScrollStateChanged(I)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnScrollListener;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnScrollListener;

    invoke-virtual {v0, p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnScrollListener;->onScrollStateChanged(Lorg/telegram/messenger/support/widget/RecyclerView;I)V
    ...
    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$OnScrollListener;
...
.method dispatchOnScrolled(II)V
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDispatchScrollCounter:I
    ...
    invoke-virtual {p0, v0, v1, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView;->onScrollChanged(IIII)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$OnScrollListener;->onScrolled(Lorg/telegram/messenger/support/widget/RecyclerView;II)V
...
.method dispatchPendingImportantForAccessibilityChanges()V
    ...
    :cond_1
    iget v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mPendingAccessibilityState:I
    ...
    iput v4, v0, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mPendingAccessibilityState:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;

    iget-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    invoke-virtual {v0, p1, p0, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;->onDrawOver(Landroid/graphics/Canvas;Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$State;)V
    ...
    :goto_3
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-boolean v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mClipToPadding:Z
    ...
    :cond_1
    iget v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->topGlowOffset:I
    ...
    :cond_2
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    :cond_3
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-boolean v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mClipToPadding:Z
    ...
    :goto_7
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mItemDecorations:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator;->isRunning()Z
...
.method public findChildViewUnder(FF)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->getChildAt(I)Landroid/view/View;
...
.method public findViewHolderForAdapterPosition(I)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDataSetHasChangedAfterLayout:Z
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->getAdapterPositionFor(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)I
    ...
    invoke-virtual {v1, v4}, Lorg/telegram/messenger/support/widget/ChildHelper;->isHidden(Landroid/view/View;)Z
...
.method findViewHolderForPosition(IZ)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v1, v2}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Lorg/telegram/messenger/support/widget/ChildHelper;->isHidden(Landroid/view/View;)Z
...
.method public fling(II)Z
    ...
    iget v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMinFlingVelocity:I
    ...
    invoke-virtual {p0, v4, v5}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {p0, v3, v4, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchNestedFling(FFZ)Z

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mOnFlingListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnFlingListener;

    if-eqz v3, :cond_9

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mOnFlingListener:Lorg/telegram/messenger/support/widget/RecyclerView$OnFlingListener;

    invoke-virtual {v3, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$OnFlingListener;->onFling(II)Z
    ...
    iget v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMaxFlingVelocity:I
    ...
    invoke-virtual {v3, v0, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->fling(II)V
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onInterceptFocusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    :goto_3
    sget-boolean v6, Lorg/telegram/messenger/support/widget/RecyclerView;->FORCE_ABS_FOCUS_SEARCH_DIRECTION:Z
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->getLayoutDirection()I
    ...
    :goto_8
    sget-boolean v3, Lorg/telegram/messenger/support/widget/RecyclerView;->FORCE_ABS_FOCUS_SEARCH_DIRECTION:Z
    ...
    invoke-virtual {v0, p1, p2, v1, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onFocusSearchFailed(Landroid/view/View;ILorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)Landroid/view/View;
    ...
    :goto_a
    invoke-direct {p0, p1, v0, p2}, Lorg/telegram/messenger/support/widget/RecyclerView;->isPreferredNextFocus(Landroid/view/View;Landroid/view/View;I)Z
...
.method getItemDecorInsetsForChild(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    iget-boolean v1, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->mInsetsDirty:Z
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->isItemChanged()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->isViewInvalid()Z
    ...
    :cond_2
    iget-object v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->mDecorInsets:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTempRect:Landroid/graphics/Rect;
    ...
    check-cast v1, Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;

    iget-object v6, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTempRect:Landroid/graphics/Rect;

    iget-object v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    invoke-virtual {v1, v6, p1, p0, v7}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;->getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$State;)V
...
.method markItemDecorInsetsDirty()V
    ...
    invoke-virtual {v0, v1}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;
    ...
    iput-boolean v3, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->mInsetsDirty:Z
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->markItemDecorInsetsDirty()V
...
.method markKnownViewsInvalid()V
    ...
    invoke-virtual {v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->markKnownViewsInvalid()V
...
.method offsetPositionRecordsForInsert(II)V
    ...
    invoke-virtual {v3, v0}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v3, p2, v1}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->offsetPosition(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->offsetPositionRecordsForInsert(II)V
...
.method offsetPositionRecordsForMove(II)V
    ...
    invoke-virtual {v7, v4}, Lorg/telegram/messenger/support/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;

    move-result-object v7

    invoke-static {v7}, Lorg/telegram/messenger/support/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    move-result-object v7

    if-eqz v7, :cond_0

    iget v8, v7, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    invoke-virtual {v7, v8, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->offsetPosition(IZ)V

    :goto_3
    iget-object v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v1, v7, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mStructureChanged:Z

    goto :goto_2

    :cond_3
    invoke-virtual {v7, v0, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->offsetPosition(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->offsetPositionRecordsForMove(II)V
...
.method offsetPositionRecordsForRemove(IIZ)V
    ...
    invoke-virtual {v3, v4, p3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->offsetPosition(IZ)V

    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v6, v3, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mStructureChanged:Z
    ...
    invoke-virtual {v3, v4, v5, p3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->flagRemovedAndOffsetPosition(IIZ)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->offsetPositionRecordsForRemove(IIZ)V
...
.method protected onAttachedToWindow()V
    ...
    sget-object v0, Lorg/telegram/messenger/support/widget/GapWorker;->sGapWorker:Ljava/lang/ThreadLocal;

    invoke-virtual {v0}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/telegram/messenger/support/widget/GapWorker;
    ...
    new-instance v0, Lorg/telegram/messenger/support/widget/GapWorker;

    invoke-direct {v0}, Lorg/telegram/messenger/support/widget/GapWorker;-><init>()V
    ...
    :goto_1
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mGapWorker:Lorg/telegram/messenger/support/widget/GapWorker;
    ...
    iput-wide v2, v1, Lorg/telegram/messenger/support/widget/GapWorker;->mFrameIntervalNs:J
    ...
    invoke-virtual {v0, p0}, Lorg/telegram/messenger/support/widget/GapWorker;->add(Lorg/telegram/messenger/support/widget/RecyclerView;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1, p0, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$ItemDecoration;->onDraw(Landroid/graphics/Canvas;Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$State;)V
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    invoke-virtual {p0, v2, v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->scrollByInternal(IILandroid/view/MotionEvent;)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchOnItemTouchIntercept(Landroid/view/MotionEvent;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-direct {p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->cancelTouch()V
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->canScrollVertically()Z

    move-result v4

    iget-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    :pswitch_1
    iget-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mIgnoreMotionEventTillDown:Z

    if-eqz v1, :cond_5

    iput-boolean v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mIgnoreMotionEventTillDown:Z
    ...
    iput v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLastTouchY:I

    iput v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchY:I

    iget v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollState:I

    const/4 v5, 0x2

    if-ne v1, v5, :cond_6

    invoke-virtual {p0}, Lorg/telegram/messenger/support/widget/RecyclerView;->getParent()Landroid/view/ViewParent;

    move-result-object v1

    invoke-interface {v1, v2}, Landroid/view/ViewParent;->requestDisallowInterceptTouchEvent(Z)V

    invoke-virtual {p0, v2}, Lorg/telegram/messenger/support/widget/RecyclerView;->setScrollState(I)V

    :cond_6
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I

    iget-object v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I
    ...
    :cond_7
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->startNestedScroll(I)Z
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchX:I
    ...
    :pswitch_3
    iget v5, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollPointerId:I
    ...
    iget v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollState:I

    if-eq v7, v2, :cond_4

    iget v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchX:I

    sub-int/2addr v6, v7

    iget v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchY:I
    ...
    iget v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I

    if-le v0, v7, :cond_d

    iget v7, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchX:I

    iget v8, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I
    ...
    iget v6, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I

    if-le v4, v6, :cond_9

    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mInitialTouchY:I

    iget v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I
    ...
    :pswitch_4
    invoke-direct {p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->onPointerUp(Landroid/view/MotionEvent;)V
...
.method protected onMeasure(II)V
    ...
    iget-boolean v2, v2, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->mAutoMeasure:Z
    ...
    invoke-virtual {v2, v3, v4, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onMeasure(Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;II)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->setMeasureSpecs(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->setMeasuredDimensionFromChildren(II)V

    iget-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayout:Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;

    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->shouldMeasureTwice()Z
    ...
    invoke-virtual {v0, v2, v3}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->setMeasureSpecs(II)V
    ...
    :cond_4
    iget-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mHasFixedSize:Z
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onMeasure(Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;II)V

    goto :goto_0

    :cond_5
    iget-boolean v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mAdapterUpdateDuringMeasure:Z
    ...
    iput-boolean v1, v2, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mInPreLayout:Z

    :goto_1
    iput-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mAdapterUpdateDuringMeasure:Z
    ...
    iput v2, v1, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mItemCount:I
    ...
    invoke-virtual {v1, v2, v3, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onMeasure(Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;II)V

    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->resumeRequestLayout(Z)V

    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mState:Lorg/telegram/messenger/support/widget/RecyclerView$State;

    iput-boolean v0, v1, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mInPreLayout:Z
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/support/widget/AdapterHelper;->consumeUpdatesInOnePass()V
    ...
    iput v0, v1, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mItemCount:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mIgnoreMotionEventTillDown:Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchOnItemTouch(Landroid/view/MotionEvent;)Z
    ...
    iput-object v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget-object v8, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I

    iget-object v9, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I
    ...
    :pswitch_3
    iget v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollPointerId:I
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollConsumed:[I

    iget-object v10, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I

    invoke-virtual {p0, v1, v0, v2, v10}, Lorg/telegram/messenger/support/widget/RecyclerView;->dispatchNestedPreScroll(II[I[I)Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I
    ...
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mNestedOffsets:[I

    aget v10, v2, v3

    iget-object v11, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I
    ...
    :cond_9
    iget v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollState:I
    ...
    iget v10, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I

    if-le v2, v10, :cond_17

    if-lez v1, :cond_e

    iget v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I
    ...
    iget v11, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I
    ...
    invoke-virtual {p0, v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->setScrollState(I)V
    ...
    :goto_7
    invoke-virtual {p0, v5, v2, v7}, Lorg/telegram/messenger/support/widget/RecyclerView;->scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    :cond_c
    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mGapWorker:Lorg/telegram/messenger/support/widget/GapWorker;
    ...
    invoke-virtual {v2, p0, v1, v0}, Lorg/telegram/messenger/support/widget/GapWorker;->postFromTraversal(Lorg/telegram/messenger/support/widget/RecyclerView;II)V
    ...
    iget v8, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mMaxFlingVelocity:I
    ...
    invoke-virtual {p0, v1, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->fling(II)Z
    ...
    :cond_13
    invoke-virtual {p0, v3}, Lorg/telegram/messenger/support/widget/RecyclerView;->setScrollState(I)V
...
.method recordAnimationInfoIfBouncedHiddenView(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    iget-boolean v0, v0, Lorg/telegram/messenger/support/widget/RecyclerView$State;->mTrackOldChangeHolders:Z
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/ViewInfoStore;->addToPreLayout(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;Lorg/telegram/messenger/support/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
...
.method removeAnimatingView(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1}, Lorg/telegram/messenger/support/widget/ChildHelper;->removeViewIfHidden(Landroid/view/View;)Z
    ...
    invoke-virtual {v2, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->unscrapView(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V

    iget-object v2, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mRecycler:Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;

    invoke-virtual {v2, v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->recycleViewHolderInternal(Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;)V
...
.method repositionShadowingViews()V
    ...
    iget-object v4, v3, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mShadowingHolder:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    if-eqz v4, :cond_1

    iget-object v3, v3, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mShadowingHolder:Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;

    iget-object v3, v3, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0, v2, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->onRequestChildFocus(Lorg/telegram/messenger/support/widget/RecyclerView;Lorg/telegram/messenger/support/widget/RecyclerView$State;Landroid/view/View;Landroid/view/View;)Z
    ...
    instance-of v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;

    if-eqz v2, :cond_0

    check-cast v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;

    iget-boolean v2, v0, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutParams;->mInsetsDirty:Z
    ...
    :goto_0
    invoke-virtual {p0, p1, v2, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-interface {v0, p1}, Lorg/telegram/messenger/support/widget/RecyclerView$OnItemTouchListener;->onRequestDisallowInterceptTouchEvent(Z)V
...
.method saveOldPositions()V
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->saveOldPosition()V
...
.method public scrollBy(II)V
    ...
    :cond_1
    iget-boolean v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayoutFrozen:Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
    ...
    invoke-virtual {p0, p1, p2, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->scrollByInternal(IILandroid/view/MotionEvent;)Z
...
.method scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1, v1, v2}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->scrollHorizontallyBy(ILorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v0, p2, v1, v4}, Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;->scrollVerticallyBy(ILorg/telegram/messenger/support/widget/RecyclerView$Recycler;Lorg/telegram/messenger/support/widget/RecyclerView$State;)I
    ...
    iget-object v3, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I
    ...
    iget-object v4, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mScrollOffset:[I
    ...
    invoke-direct {p0, v0, v3, v5, v4}, Lorg/telegram/messenger/support/widget/RecyclerView;->pullGlows(FFFF)V
...
.method setDataSetChangedAfterLayout()V
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mDataSetHasChangedAfterLayout:Z
    ...
    invoke-virtual {v0}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->setAdapterPositionsAsUnknown()V
...
.method public setLayoutFrozen(Z)V
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->assertNotInLayoutOrScroll(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/support/widget/RecyclerView;->onTouchEvent(Landroid/view/MotionEvent;)Z

    iput-boolean v8, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mLayoutFrozen:Z

    iput-boolean v8, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mIgnoreMotionEventTillDown:Z
...
.method public setOnFlingListener(Lorg/telegram/messenger/support/widget/RecyclerView$OnFlingListener;)V
    .locals 0
    .param p1    # Lorg/telegram/messenger/support/widget/RecyclerView$OnFlingListener;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
...
.method public setScrollingTouchSlop(I)V
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mTouchSlop:I
...
.method shouldDeferAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iput v0, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mEatenAccessibilityChangeFlags:I
...
.method public smoothScrollBy(IILandroid/view/animation/Interpolator;)V
    ...
    :cond_3
    iget-object v1, p0, Lorg/telegram/messenger/support/widget/RecyclerView;->mViewFlinger:Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;

    invoke-virtual {v1, p1, v0, p3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewFlinger;->smoothScrollBy(IILandroid/view/animation/Interpolator;)V
...
.method viewRangeUpdate(IILjava/lang/Object;)V
    ...
    invoke-virtual {v4}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    :cond_1
    iget v5, v4, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    invoke-virtual {v4, v5}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->addFlags(I)V

    invoke-virtual {v4, p3}, Lorg/telegram/messenger/support/widget/RecyclerView$ViewHolder;->addChangePayload(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/telegram/messenger/support/widget/RecyclerView$Recycler;->viewRangeUpdate(II)V
