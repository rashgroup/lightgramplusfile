...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/ContactsController;->contactsDict:Landroid/util/SparseArray;
...
.method private applyContactsUpdates(Ljava/util/ArrayList;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v6, v0, Lorg/telegram/messenger/ContactsController$Contact;->shortPhones:Ljava/util/ArrayList;
    ...
    new-instance v6, Lorg/telegram/messenger/ContactsController$13;

    invoke-direct {v6, p0, v0}, Lorg/telegram/messenger/ContactsController$13;-><init>(Lorg/telegram/messenger/ContactsController;Ljava/lang/Integer;)V
    ...
    new-instance v1, Lorg/telegram/messenger/ContactsController$14;

    invoke-direct {v1, p0}, Lorg/telegram/messenger/ContactsController$14;-><init>(Lorg/telegram/messenger/ContactsController;)V
    ...
    :cond_14
    new-instance v0, Lorg/telegram/messenger/ContactsController$15;

    invoke-direct {v0, p0, p3, p4}, Lorg/telegram/messenger/ContactsController$15;-><init>(Lorg/telegram/messenger/ContactsController;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method private buildContactsSectionsArrays(Z)V
    ...
    new-instance v1, Lorg/telegram/messenger/ContactsController$10;

    invoke-direct {v1, p0}, Lorg/telegram/messenger/ContactsController$10;-><init>(Lorg/telegram/messenger/ContactsController;)V
    ...
    invoke-direct {v0, p0}, Lorg/telegram/messenger/ContactsController$11;-><init>(Lorg/telegram/messenger/ContactsController;)V
...
.method private checkContactsInternal()Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/ContactsController;->lastContactsVersions:Ljava/lang/String;
...
.method private performWriteContactsToPhoneBookInternal(Ljava/util/ArrayList;)V
    ...
    iget-object v2, p0, Lorg/telegram/messenger/ContactsController;->currentAccount:Landroid/accounts/Account;
    ...
    invoke-virtual {p0, v0, v3}, Lorg/telegram/messenger/ContactsController;->addContactToPhoneBook(Lorg/telegram/tgnet/TLRPC$User;Z)J
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method private readContactsFromPhoneBook()Ljava/util/HashMap;
    ...
    iput-object v10, v1, Lorg/telegram/messenger/ContactsController$Contact;->first_name:Ljava/lang/String;

    const-string/jumbo v10, ""

    iput-object v10, v1, Lorg/telegram/messenger/ContactsController$Contact;->last_name:Ljava/lang/String;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v10

    iput v10, v1, Lorg/telegram/messenger/ContactsController$Contact;->id:I
    ...
    :goto_3
    iget-object v1, v2, Lorg/telegram/messenger/ContactsController$Contact;->shortPhones:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v2, Lorg/telegram/messenger/ContactsController$Contact;->phones:Ljava/util/ArrayList;

    invoke-virtual {v1, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v2, Lorg/telegram/messenger/ContactsController$Contact;->phoneDeleted:Ljava/util/ArrayList;
    ...
    iget-object v4, v2, Lorg/telegram/messenger/ContactsController$Contact;->phoneTypes:Ljava/util/ArrayList;
    ...
    :cond_4
    :try_start_1
    const-string/jumbo v1, "PhoneMobile"
    ...
    iget-object v1, v2, Lorg/telegram/messenger/ContactsController$Contact;->phoneTypes:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/ContactsController;->projectionNames:[Ljava/lang/String;
    ...
    iget-object v7, v0, Lorg/telegram/messenger/ContactsController$Contact;->first_name:Ljava/lang/String;
    ...
    iput-object v2, v0, Lorg/telegram/messenger/ContactsController$Contact;->first_name:Ljava/lang/String;

    iput-object v3, v0, Lorg/telegram/messenger/ContactsController$Contact;->last_name:Ljava/lang/String;
    ...
    iput-object v4, v0, Lorg/telegram/messenger/ContactsController$Contact;->first_name:Ljava/lang/String;
...
.method private updateUnregisteredContacts(Ljava/util/ArrayList;)V
    ...
    :goto_3
    iget-object v0, v1, Lorg/telegram/messenger/ContactsController$Contact;->phones:Ljava/util/ArrayList;
    ...
    iget-object v0, v1, Lorg/telegram/messenger/ContactsController$Contact;->shortPhones:Ljava/util/ArrayList;
    ...
    iget-object v0, v1, Lorg/telegram/messenger/ContactsController$Contact;->phoneDeleted:Ljava/util/ArrayList;
    ...
    :cond_6
    new-instance v0, Lorg/telegram/messenger/ContactsController$9;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/ContactsController$9;-><init>(Lorg/telegram/messenger/ContactsController;)V
...
.method public addContact(Lorg/telegram/tgnet/TLRPC$User;)V
    ...
    new-instance v2, Lorg/telegram/messenger/ContactsController$17;

    invoke-direct {v2, p0}, Lorg/telegram/messenger/ContactsController$17;-><init>(Lorg/telegram/messenger/ContactsController;)V
...
.method public addContactToPhoneBook(Lorg/telegram/tgnet/TLRPC$User;Z)J
    ...
    iget-object v2, p0, Lorg/telegram/messenger/ContactsController;->observerLock:Ljava/lang/Object;
...
.method public checkAppAccount()V
    ...
    :cond_3
    iput-object v4, p0, Lorg/telegram/messenger/ContactsController;->currentAccount:Landroid/accounts/Account;
    ...
    iput-object v0, p0, Lorg/telegram/messenger/ContactsController;->currentAccount:Landroid/accounts/Account;

    iget-object v0, p0, Lorg/telegram/messenger/ContactsController;->currentAccount:Landroid/accounts/Account;
...
.method public checkInviteText()V
    ...
    iput-object v1, p0, Lorg/telegram/messenger/ContactsController;->inviteText:Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/ContactsController;->updatingInviteText:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lorg/telegram/messenger/ContactsController;->inviteText:Ljava/lang/String;
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/ContactsController;->updatingInviteText:Z
    ...
    new-instance v2, Lorg/telegram/messenger/ContactsController$2;

    invoke-direct {v2, p0}, Lorg/telegram/messenger/ContactsController$2;-><init>(Lorg/telegram/messenger/ContactsController;)V
...
.method public deleteContact(Ljava/util/ArrayList;)V
    ...
    new-instance v3, Lorg/telegram/messenger/ContactsController$18;

    invoke-direct {v3, p0, v2, p1}, Lorg/telegram/messenger/ContactsController$18;-><init>(Lorg/telegram/messenger/ContactsController;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public getContactsCopy(Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    iget-object v4, v3, Lorg/telegram/messenger/ContactsController$Contact;->phoneDeleted:Ljava/util/ArrayList;
    ...
    iget-object v4, v3, Lorg/telegram/messenger/ContactsController$Contact;->phoneTypes:Ljava/util/ArrayList;

    iget-object v5, v0, Lorg/telegram/messenger/ContactsController$Contact;->phoneTypes:Ljava/util/ArrayList;

    invoke-virtual {v4, v5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v4, v3, Lorg/telegram/messenger/ContactsController$Contact;->shortPhones:Ljava/util/ArrayList;
    ...
    iput-object v4, v3, Lorg/telegram/messenger/ContactsController$Contact;->first_name:Ljava/lang/String;

    iget-object v4, v0, Lorg/telegram/messenger/ContactsController$Contact;->last_name:Ljava/lang/String;

    iput-object v4, v3, Lorg/telegram/messenger/ContactsController$Contact;->last_name:Ljava/lang/String;

    iget v0, v0, Lorg/telegram/messenger/ContactsController$Contact;->id:I

    iput v0, v3, Lorg/telegram/messenger/ContactsController$Contact;->id:I

    iget v0, v3, Lorg/telegram/messenger/ContactsController$Contact;->id:I
...
.method public loadContacts(ZZ)V
    ...
    const-string/jumbo v0, "load contacts from cache"
    ...
    :cond_0
    const-string/jumbo v0, "load contacts from server"
...
.method public processContactsUpdates(Ljava/util/ArrayList;Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    const-string/jumbo v3, "delay update - contacts add = "
    ...
    :cond_6
    invoke-direct {p0, p1, p2, v1, v2}, Lorg/telegram/messenger/ContactsController;->applyContactsUpdates(Ljava/util/ArrayList;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public reloadContactsStatuses()V
    ...
    new-instance v3, Lorg/telegram/messenger/ContactsController$19;

    invoke-direct {v3, p0, v0}, Lorg/telegram/messenger/ContactsController$19;-><init>(Lorg/telegram/messenger/ContactsController;Landroid/content/SharedPreferences$Editor;)V
