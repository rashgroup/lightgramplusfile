...
.method public constructor <init>(ZII)V
    ...
    new-array v0, v0, [Lorg/telegram/messenger/exoplayer2/upstream/Allocation;

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableAllocations:[Lorg/telegram/messenger/exoplayer2/upstream/Allocation;
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->initialAllocationBlock:[B
    ...
    :cond_3
    new-array v0, v1, [Lorg/telegram/messenger/exoplayer2/upstream/Allocation;

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->singleAllocationReleaseHolder:[Lorg/telegram/messenger/exoplayer2/upstream/Allocation;
...
.method public declared-synchronized allocate()Lorg/telegram/messenger/exoplayer2/upstream/Allocation;
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->allocatedCount:I

    iget v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableCount:I

    if-lez v0, :cond_0

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableAllocations:[Lorg/telegram/messenger/exoplayer2/upstream/Allocation;

    iget v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableCount:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableCount:I
...
.method public declared-synchronized release([Lorg/telegram/messenger/exoplayer2/upstream/Allocation;)V
    ...
    iget v3, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableCount:I
    ...
    iget-object v0, v4, Lorg/telegram/messenger/exoplayer2/upstream/Allocation;->data:[B
...
.method public declared-synchronized setTargetBufferSize(I)V
    ...
    :try_start_0
    iget v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->targetBufferSize:I
...
.method public declared-synchronized trim()V
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->individualAllocationSize:I

    invoke-static {v0, v2}, Lorg/telegram/messenger/exoplayer2/util/Util;->ceilDivide(II)I

    move-result v0

    const/4 v2, 0x0

    iget v3, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->allocatedCount:I
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->initialAllocationBlock:[B
    ...
    iget-object v2, v4, Lorg/telegram/messenger/exoplayer2/upstream/Allocation;->data:[B
    ...
    iget-object v2, v5, Lorg/telegram/messenger/exoplayer2/upstream/Allocation;->data:[B

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->initialAllocationBlock:[B
    ...
    :cond_3
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableAllocations:[Lorg/telegram/messenger/exoplayer2/upstream/Allocation;

    add-int/lit8 v2, v1, 0x1

    aput-object v5, v6, v1

    iget-object v5, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableAllocations:[Lorg/telegram/messenger/exoplayer2/upstream/Allocation;
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultAllocator;->availableCount:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
