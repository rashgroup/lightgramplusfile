...
.method public close()V
    ...
    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->uri:Landroid/net/Uri;

    :try_start_0
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->inputStream:Ljava/io/InputStream;
    ...
    :cond_0
    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->inputStream:Ljava/io/InputStream;

    :try_start_1
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->assetFileDescriptor:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->assetFileDescriptor:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->opened:Z

    if-eqz v0, :cond_2

    iput-boolean v3, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->opened:Z

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->listener:Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
...
.method public open(Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;)J
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->uri:Landroid/net/Uri;

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->resolver:Landroid/content/ContentResolver;

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->uri:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->assetFileDescriptor:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->inputStream:Ljava/io/InputStream;
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->bytesRemaining:J
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->opened:Z
    ...
    :cond_2
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->bytesRemaining:J
...
.method public read([BII)I
    ...
    :cond_1
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->bytesRemaining:J
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource$ContentDataSourceException;

    new-instance v1, Ljava/io/EOFException;

    invoke-direct {v1}, Ljava/io/EOFException;-><init>()V

    invoke-direct {v0, v1}, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource$ContentDataSourceException;-><init>(Ljava/io/IOException;)V
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/ContentDataSource;->bytesRemaining:J
