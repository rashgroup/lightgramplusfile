...
.method private closeConnectionQuietly()V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
...
.method private static getContentLength(Ljava/net/HttpURLConnection;)J
    ...
    sget-object v2, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->CONTENT_RANGE_HEADER:Ljava/util/regex/Pattern;
...
.method private makeConnection(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    iget v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->connectTimeoutMillis:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setConnectTimeout(I)V

    iget v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->readTimeoutMillis:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setReadTimeout(I)V

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->requestProperties:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->userAgent:Ljava/lang/String;
...
.method private makeConnection(Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;)Ljava/net/HttpURLConnection;
    ...
    iget-object v3, p1, Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;->postBody:[B
    ...
    :goto_0
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->allowCrossProtocolRedirects:Z

    if-nez v1, :cond_1

    move-object v1, p0

    invoke-direct/range {v1 .. v9}, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->makeConnection(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v2, v9}, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->handleRedirect(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
...
.method private readInternal([BII)I
    ...
    :cond_1
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesToRead:J
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesRead:J

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->listener:Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
...
.method private skipInternal()V
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesToSkip:J
    ...
    :cond_0
    sget-object v0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->skipBufferReference:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    :goto_1
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->inputStream:Ljava/io/InputStream;
    ...
    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    invoke-interface {v2, p0, v1}, Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;->onBytesTransferred(Ljava/lang/Object;I)V

    goto :goto_1

    :cond_4
    sget-object v1, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->skipBufferReference:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public close()V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->inputStream:Ljava/io/InputStream;
    ...
    invoke-static {v0, v2, v3}, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->maybeTerminateInputStream(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->opened:Z
...
.method public open(Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;)J
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesRead:J

    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesSkipped:J
    ...
    iput-object v4, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
    ...
    new-instance v1, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$InvalidResponseCodeException;

    invoke-direct {v1, v4, v0, p1}, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$InvalidResponseCodeException;-><init>(ILjava/util/Map;Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;)V

    const/16 v0, 0x1a0

    if-ne v4, v0, :cond_1

    new-instance v0, Lorg/telegram/messenger/exoplayer2/upstream/DataSourceException;

    const/4 v2, 0x0

    invoke-direct {v0, v2}, Lorg/telegram/messenger/exoplayer2/upstream/DataSourceException;-><init>(I)V

    invoke-virtual {v1, v0}, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$InvalidResponseCodeException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-direct {v1, v2, v0, p1, v7}, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/lang/String;Ljava/io/IOException;Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;I)V
    ...
    :cond_2
    iget-object v5, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;

    invoke-virtual {v5}, Ljava/net/HttpURLConnection;->getContentType()Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->contentTypePredicate:Lorg/telegram/messenger/exoplayer2/util/Predicate;

    if-eqz v6, :cond_3

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->contentTypePredicate:Lorg/telegram/messenger/exoplayer2/util/Predicate;

    invoke-interface {v6, v5}, Lorg/telegram/messenger/exoplayer2/util/Predicate;->evaluate(Ljava/lang/Object;)Z
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$InvalidContentTypeException;

    invoke-direct {v0, v5, p1}, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$InvalidContentTypeException;-><init>(Ljava/lang/String;Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;)V
    ...
    :cond_4
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesToSkip:J

    iget v0, p1, Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;->flags:I
    ...
    iput-wide v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->bytesToRead:J
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->inputStream:Ljava/io/InputStream;
    :try_end_2
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer2/upstream/DefaultHttpDataSource;->getContentLength(Ljava/net/HttpURLConnection;)J
    ...
    invoke-direct {v1, v0, p1, v7}, Lorg/telegram/messenger/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lorg/telegram/messenger/exoplayer2/upstream/DataSpec;I)V
