...
.method private drainOutputBuffer()Z
    ...
    iput-boolean v6, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->outputStreamEnded:Z
    ...
    iput-object v7, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->outputBuffer:Lorg/telegram/messenger/exoplayer2/decoder/SimpleOutputBuffer;
    ...
    iget-object v1, v4, Lorg/telegram/messenger/exoplayer2/Format;->sampleMimeType:Ljava/lang/String;

    iget v2, v4, Lorg/telegram/messenger/exoplayer2/Format;->channelCount:I

    iget v3, v4, Lorg/telegram/messenger/exoplayer2/Format;->sampleRate:I

    iget v4, v4, Lorg/telegram/messenger/exoplayer2/Format;->pcmEncoding:I
    ...
    iput-boolean v6, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->allowPositionDiscontinuity:Z
...
.method private feedInputBuffer()Z
    ...
    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->inputStreamEnded:Z
    ...
    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->dequeueInputBuffer()Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;
    ...
    :cond_2
    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->waitingForKeys:Z
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->formatHolder:Lorg/telegram/messenger/exoplayer2/FormatHolder;

    iget-object v0, v0, Lorg/telegram/messenger/exoplayer2/FormatHolder;->format:Lorg/telegram/messenger/exoplayer2/Format;

    invoke-direct {p0, v0}, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->onInputFormatChanged(Lorg/telegram/messenger/exoplayer2/Format;)V
    ...
    invoke-virtual {p0, v2, v3}, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->readSource(Lorg/telegram/messenger/exoplayer2/FormatHolder;Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;)I
    ...
    invoke-virtual {v1, v2}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->queueInputBuffer(Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;)V
    ...
    invoke-direct {p0, v2}, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->shouldWaitForKeys(Z)Z

    move-result v2

    iput-boolean v2, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->waitingForKeys:Z

    iget-boolean v2, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->waitingForKeys:Z

    if-nez v2, :cond_0

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->inputBuffer:Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->queueInputBuffer(Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;)V

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->decoderCounters:Lorg/telegram/messenger/exoplayer2/decoder/DecoderCounters;

    iget v2, v0, Lorg/telegram/messenger/exoplayer2/decoder/DecoderCounters;->inputBufferCount:I

    add-int/lit8 v2, v2, 0x1

    iput v2, v0, Lorg/telegram/messenger/exoplayer2/decoder/DecoderCounters;->inputBufferCount:I
...
.method private onInputFormatChanged(Lorg/telegram/messenger/exoplayer2/Format;)V
    ...
    :goto_0
    invoke-static {v2, v0}, Lorg/telegram/messenger/exoplayer2/util/Util;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/telegram/messenger/exoplayer2/drm/DrmSessionManager;->acquireSession(Landroid/os/Looper;Lorg/telegram/messenger/exoplayer2/drm/DrmInitData;)Lorg/telegram/messenger/exoplayer2/drm/DrmSession;

    move-result-object v0

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->pendingDrmSession:Lorg/telegram/messenger/exoplayer2/drm/DrmSession;
    ...
    :cond_4
    iput-object v1, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->pendingDrmSession:Lorg/telegram/messenger/exoplayer2/drm/DrmSession;
...
.method private readFormat()Z
    ...
    invoke-virtual {p0, v0, v1}, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->readSource(Lorg/telegram/messenger/exoplayer2/FormatHolder;Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;)I
...
.method private shouldWaitForKeys(Z)Z
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->playClearSamplesWithoutKeys:Z
...
.method public getPositionUs()J
    ...
    :cond_0
    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->currentPositionUs:J
...
.method public render(JJ)V
    ...
    invoke-virtual {p0, v1, v0}, Lorg/telegram/messenger/exoplayer2/audio/SimpleDecoderAudioRenderer;->createDecoder(Lorg/telegram/messenger/exoplayer2/Format;Lorg/telegram/messenger/exoplayer2/drm/ExoMediaCrypto;)Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;
