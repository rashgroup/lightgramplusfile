...
.method protected constructor <init>([Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;[Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;)V
    ...
    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->lock:Ljava/lang/Object;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->queuedInputBuffers:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->queuedOutputBuffers:Ljava/util/LinkedList;
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableInputBufferCount:I
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableInputBuffers:[Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;
    ...
    iput v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableOutputBufferCount:I
    ...
    :cond_1
    new-instance v0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder$1;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder$1;-><init>(Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;)V

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->decodeThread:Ljava/lang/Thread;

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->decodeThread:Ljava/lang/Thread;
...
.method private decode()Z
    ...
    :goto_0
    :try_start_0
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->released:Z
    ...
    iget-object v3, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableOutputBuffers:[Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;

    iget v4, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableOutputBufferCount:I

    add-int/lit8 v4, v4, -0x1

    iput v4, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->availableOutputBufferCount:I

    aget-object v3, v3, v4

    iget-boolean v4, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->flushed:Z
    ...
    invoke-virtual {v3, v1}, Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;->addFlag(I)V
    ...
    invoke-direct {p0, v3}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->releaseOutputBufferInternal(Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;)V
    ...
    invoke-virtual {v3, v2}, Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;->addFlag(I)V

    :cond_4
    invoke-virtual {p0, v0, v3, v4}, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->decode(Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;Z)Ljava/lang/Exception;

    move-result-object v2

    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->exception:Ljava/lang/Exception;

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->exception:Ljava/lang/Exception;
    ...
    :cond_5
    :try_start_4
    invoke-virtual {v3}, Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;->isDecodeOnly()Z

    move-result v2

    if-eqz v2, :cond_6

    iget v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->skippedOutputBufferCount:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->skippedOutputBufferCount:I
    ...
    iput v2, v3, Lorg/telegram/messenger/exoplayer2/decoder/OutputBuffer;->skippedOutputBufferCount:I

    const/4 v2, 0x0

    iput v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->skippedOutputBufferCount:I

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->queuedOutputBuffers:Ljava/util/LinkedList;
...
.method public release()V
    ...
    :try_start_0
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/decoder/SimpleDecoder;->released:Z
...
.method protected final setInitialInputBufferSize(I)V
    ...
    invoke-virtual {v3, p1}, Lorg/telegram/messenger/exoplayer2/decoder/DecoderInputBuffer;->ensureSpaceForWrite(I)V
