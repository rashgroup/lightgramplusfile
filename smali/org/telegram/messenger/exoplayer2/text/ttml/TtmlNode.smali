...
.method private applyStyleToOutput(Ljava/util/Map;Landroid/text/SpannableStringBuilder;II)V
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->style:Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlStyle;

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->styleIds:[Ljava/lang/String;

    invoke-static {v0, v1, p1}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRenderUtil;->resolveStyle(Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlStyle;
...
.method private getEventTimes(Ljava/util/TreeSet;Z)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->tag:Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {v0, p1, v3}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->getEventTimes(Ljava/util/TreeSet;Z)V
...
.method private traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1, v1, v2, v0}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->applyStyleToOutput(Ljava/util/Map;Landroid/text/SpannableStringBuilder;II)V
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->getChild(I)Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;

    move-result-object v1

    invoke-direct {v1, p1, p2}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
...
.method private traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;
    ...
    :cond_0
    iget-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->isTextNode:Z
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->text:Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRenderUtil;->endParagraph(Landroid/text/SpannableStringBuilder;)V
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
...
.method public getCues(JLjava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-direct {p0, p3, v6}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
    ...
    check-cast v8, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRegion;
    ...
    invoke-direct {p0, v1}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->cleanUpText(Landroid/text/SpannableStringBuilder;)Landroid/text/SpannableStringBuilder;

    move-result-object v1

    const/4 v2, 0x0

    iget v3, v8, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRegion;->line:F

    iget v4, v8, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRegion;->lineType:I

    const/high16 v5, -0x80000000

    iget v6, v8, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRegion;->position:F

    const/high16 v7, -0x80000000

    iget v8, v8, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlRegion;->width:F
...
.method public getEventTimesUs()[J
    ...
    invoke-direct {p0, v1, v0}, Lorg/telegram/messenger/exoplayer2/text/ttml/TtmlNode;->getEventTimes(Ljava/util/TreeSet;Z)V
