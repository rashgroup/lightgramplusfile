...
.method public getAdaptiveSupport(IIZ)I
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->trackGroups:[Lorg/telegram/messenger/exoplayer2/source/TrackGroupArray;

    aget-object v1, v1, p1

    invoke-virtual {v1, p2}, Lorg/telegram/messenger/exoplayer2/source/TrackGroupArray;->get(I)Lorg/telegram/messenger/exoplayer2/source/TrackGroup;

    move-result-object v1

    iget v3, v1, Lorg/telegram/messenger/exoplayer2/source/TrackGroup;->length:I
    ...
    invoke-virtual {p0, p1, p2, v2}, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->getTrackFormatSupport(III)I
    ...
    invoke-virtual {p0, p1, p2, v0}, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->getAdaptiveSupport(II[I)I
...
.method public getAdaptiveSupport(II[I)I
    ...
    iget-object v7, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->trackGroups:[Lorg/telegram/messenger/exoplayer2/source/TrackGroupArray;

    aget-object v7, v7, p1

    invoke-virtual {v7, p2}, Lorg/telegram/messenger/exoplayer2/source/TrackGroupArray;->get(I)Lorg/telegram/messenger/exoplayer2/source/TrackGroup;

    move-result-object v7

    invoke-virtual {v7, v0}, Lorg/telegram/messenger/exoplayer2/source/TrackGroup;->getFormat(I)Lorg/telegram/messenger/exoplayer2/Format;
    ...
    :goto_1
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->formatSupport:[[[I
    ...
    :cond_0
    invoke-static {v1, v0}, Lorg/telegram/messenger/exoplayer2/util/Util;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->mixedMimeTypeAdaptiveSupport:[I
...
.method public hasOnlyUnplayableTracks(I)Z
    ...
    :goto_0
    iget v4, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->length:I

    if-ge v0, v4, :cond_1

    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector$MappedTrackInfo;->rendererTrackTypes:[I
