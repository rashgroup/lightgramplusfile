...
.method private readFlvHeader(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;)Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->headerBuffer:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->data:[B

    invoke-interface {p1, v2, v0, v5, v1}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->readFully([BIIZ)Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->audioReader:Lorg/telegram/messenger/exoplayer2/extractor/flv/AudioTagPayloadReader;

    if-nez v2, :cond_2

    new-instance v2, Lorg/telegram/messenger/exoplayer2/extractor/flv/AudioTagPayloadReader;
    ...
    invoke-interface {v3, v4}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorOutput;->track(I)Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;

    move-result-object v3

    invoke-direct {v2, v3}, Lorg/telegram/messenger/exoplayer2/extractor/flv/AudioTagPayloadReader;-><init>(Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;)V

    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->audioReader:Lorg/telegram/messenger/exoplayer2/extractor/flv/AudioTagPayloadReader;

    :cond_2
    if-eqz v0, :cond_3

    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->videoReader:Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;

    if-nez v0, :cond_3

    new-instance v0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->extractorOutput:Lorg/telegram/messenger/exoplayer2/extractor/ExtractorOutput;

    invoke-interface {v2, v5}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorOutput;->track(I)Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;

    move-result-object v2

    invoke-direct {v0, v2}, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;-><init>(Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;)V

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->videoReader:Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer2/extractor/flv/ScriptTagPayloadReader;

    const/4 v2, 0x0

    invoke-direct {v0, v2}, Lorg/telegram/messenger/exoplayer2/extractor/flv/ScriptTagPayloadReader;-><init>(Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;)V

    iput-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->metadataReader:Lorg/telegram/messenger/exoplayer2/extractor/flv/ScriptTagPayloadReader;

    :cond_4
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->extractorOutput:Lorg/telegram/messenger/exoplayer2/extractor/ExtractorOutput;
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->headerBuffer:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;
...
.method public sniff(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;)Z
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->scratch:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;
    ...
    invoke-virtual {v1}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readUnsignedInt24()I

    move-result v1

    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/flv/FlvExtractor;->FLV_TAG:I
    ...
    invoke-interface {p1, v1, v0, v3}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
