...
.method protected parseHeader(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Z
    ...
    :cond_0
    iput v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->frameType:I
...
.method protected parsePayload(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;J)V
    ...
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->hasOutputFormat:Z
    ...
    invoke-virtual {p1, v1, v2, v3}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readBytes([BII)V
    ...
    iget v0, v10, Lorg/telegram/messenger/exoplayer2/video/AvcConfig;->nalUnitLengthFieldLength:I

    iput v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalUnitLengthFieldLength:I
    ...
    iget v5, v10, Lorg/telegram/messenger/exoplayer2/video/AvcConfig;->width:I

    iget v6, v10, Lorg/telegram/messenger/exoplayer2/video/AvcConfig;->height:I

    const/high16 v7, -0x40800000    # -1.0f

    iget-object v8, v10, Lorg/telegram/messenger/exoplayer2/video/AvcConfig;->initializationData:Ljava/util/List;

    const/4 v9, -0x1

    iget v10, v10, Lorg/telegram/messenger/exoplayer2/video/AvcConfig;->pixelWidthAspectRatio:F
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->output:Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;
    ...
    iput-boolean v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->hasOutputFormat:Z
    ...
    iget-object v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalLength:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalUnitLengthFieldLength:I
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalLength:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    iget-object v1, v1, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->data:[B

    iget v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalUnitLengthFieldLength:I

    invoke-virtual {p1, v1, v0, v4}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readBytes([BII)V
    ...
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalStartCode:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    const/4 v6, 0x0

    invoke-virtual {v4, v6}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->setPosition(I)V

    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->output:Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;

    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->nalStartCode:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    const/4 v7, 0x4

    invoke-interface {v4, v6, v7}, Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;I)V

    add-int/lit8 v4, v5, 0x4

    iget-object v5, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->output:Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;

    invoke-interface {v5, p1, v1}, Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;I)V
    ...
    iget v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/flv/VideoTagPayloadReader;->frameType:I
