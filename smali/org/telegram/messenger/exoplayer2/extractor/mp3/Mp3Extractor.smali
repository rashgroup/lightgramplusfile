...
.method private peekId3Data(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;)V
    ...
    :goto_0
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->scratch:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    iget-object v2, v2, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->data:[B

    invoke-interface {p1, v2, v1, v6}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
    ...
    sget v3, Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Decoder;->ID3_TAG:I
    ...
    invoke-virtual {v2, v3}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->skipBytes(I)V

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->scratch:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    invoke-virtual {v2}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readSynchSafeInt()I
    ...
    invoke-interface {p1, v4, v6, v2}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
    ...
    invoke-virtual {v2, v4, v3}, Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Decoder;->decode([BI)Lorg/telegram/messenger/exoplayer2/metadata/Metadata;

    move-result-object v2

    iput-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->metadata:Lorg/telegram/messenger/exoplayer2/metadata/Metadata;

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->metadata:Lorg/telegram/messenger/exoplayer2/metadata/Metadata;

    if-eqz v2, :cond_1

    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->gaplessInfoHolder:Lorg/telegram/messenger/exoplayer2/extractor/GaplessInfoHolder;

    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->metadata:Lorg/telegram/messenger/exoplayer2/metadata/Metadata;

    invoke-virtual {v2, v4}, Lorg/telegram/messenger/exoplayer2/extractor/GaplessInfoHolder;->setFromMetadata(Lorg/telegram/messenger/exoplayer2/metadata/Metadata;)Z
...
.method private readSample(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;)I
    ...
    invoke-interface {p1, v1, v6, v2, v4}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BIIZ)Z
    ...
    iget v3, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeaderData:I

    and-int/2addr v3, v5

    if-ne v2, v3, :cond_2

    invoke-static {v1}, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->getFrameSize(I)I
    ...
    iput v6, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeaderData:I

    goto :goto_0

    :cond_3
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeader:Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->basisTimeUs:J
    ...
    invoke-interface {v1, v2, v3}, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor$Seeker;->getTimeUs(J)J

    move-result-wide v2

    iput-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->basisTimeUs:J

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->forcedFirstSampleTimestampUs:J
    ...
    iget-wide v8, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->basisTimeUs:J

    iget-wide v10, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->forcedFirstSampleTimestampUs:J
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->sampleBytesRemaining:I

    invoke-interface {v1, p1, v2, v4}, Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;->sampleData(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;IZ)I
    ...
    :cond_6
    iget v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->sampleBytesRemaining:I

    sub-int/2addr v0, v1

    iput v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->sampleBytesRemaining:I

    iget v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->sampleBytesRemaining:I

    if-gtz v0, :cond_0

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->basisTimeUs:J

    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->samplesRead:J
    ...
    iget v5, v5, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->sampleRate:I
    ...
    iget v5, v0, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->frameSize:I

    const/4 v7, 0x0

    invoke-interface/range {v1 .. v7}, Lorg/telegram/messenger/exoplayer2/extractor/TrackOutput;->sampleMetadata(JIII[B)V

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->samplesRead:J
    ...
    iput v6, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->sampleBytesRemaining:I
...
.method private setupSeeker(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;)Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor$Seeker;
    ...
    iget v2, v2, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->frameSize:I

    invoke-direct {v1, v2}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;-><init>(I)V

    iget-object v2, v1, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->data:[B

    iget-object v3, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeader:Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;

    iget v3, v3, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->frameSize:I

    invoke-interface {p1, v2, v8, v3}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
    ...
    :goto_1
    sget v10, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->XING_HEADER:I

    if-eq v7, v10, :cond_1

    sget v10, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->INFO_HEADER:I
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->gaplessInfoHolder:Lorg/telegram/messenger/exoplayer2/extractor/GaplessInfoHolder;

    invoke-virtual {v1}, Lorg/telegram/messenger/exoplayer2/extractor/GaplessInfoHolder;->hasGaplessInfo()Z
    ...
    invoke-interface {p1, v1, v8, v2}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
    ...
    invoke-virtual {v1, v2}, Lorg/telegram/messenger/exoplayer2/extractor/GaplessInfoHolder;->setFromXingHeaderValue(I)Z
    ...
    invoke-interface {p1, v0, v8, v1}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BII)V
    ...
    new-instance v0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/ConstantBitrateSeeker;
    ...
    iget v3, v3, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->bitrate:I

    invoke-direct/range {v0 .. v5}, Lorg/telegram/messenger/exoplayer2/extractor/mp3/ConstantBitrateSeeker;-><init>(JIJ)V
    ...
    sget v6, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->VBRI_HEADER:I
...
.method private synchronize(Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;Z)Z
    ...
    :goto_1
    iget-object v6, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->scratch:Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;

    iget-object v8, v6, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->data:[B
    ...
    :goto_2
    invoke-interface {p1, v8, v2, v11, v6}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->peekFully([BIIZ)Z
    ...
    :goto_4
    iput v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeaderData:I
    ...
    invoke-virtual {v6}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readInt()I
    ...
    :cond_5
    invoke-static {v6}, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->getFrameSize(I)I
    ...
    :cond_8
    invoke-interface {p1, v7}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->skipFully(I)V
    ...
    iget-object v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/Mp3Extractor;->synchronizedHeader:Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;

    invoke-static {v6, v4}, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->populateHeader(ILorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;)Z
    ...
    invoke-interface {p1, v6}, Lorg/telegram/messenger/exoplayer2/extractor/ExtractorInput;->advancePeekPosition(I)V
