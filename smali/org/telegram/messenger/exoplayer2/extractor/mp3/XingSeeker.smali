...
.method public static create(Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;JJ)Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;
    ...
    iget v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->samplesPerFrame:I

    iget v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->sampleRate:I

    iget v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->frameSize:I
    ...
    new-instance v1, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;

    move-wide v2, v6

    move-wide/from16 v6, p4

    invoke-direct/range {v1 .. v7}, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;-><init>(JJJ)V
    ...
    iget v11, p0, Lorg/telegram/messenger/exoplayer2/extractor/MpegAudioHeader;->frameSize:I
...
.method public getPosition(J)J
    ...
    invoke-virtual {p0}, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->isSeekable()Z

    move-result v2

    if-nez v2, :cond_0

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->firstFramePosition:J
    ...
    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->durationUs:J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->sizeBytes:J
    ...
    iget-wide v2, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->firstFramePosition:J

    add-long/2addr v2, v0

    iget-wide v0, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->inputLength:J
    ...
    :cond_4
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->tableOfContents:[J
    ...
    iget v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->headerSize:I

    int-to-long v4, v4

    sub-long/2addr v0, v4

    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->sizeBytes:J
...
.method public getTimeUs(J)J
    ...
    iget-wide v4, p0, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->firstFramePosition:J
    ...
    invoke-static {v0, v4, v5, v1, v8}, Lorg/telegram/messenger/exoplayer2/util/Util;->binarySearchFloor([JJZZ)I

    move-result v0

    add-int/lit8 v8, v0, 0x1

    invoke-direct {p0, v8}, Lorg/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker;->getTimeUsForTocPosition(I)J
