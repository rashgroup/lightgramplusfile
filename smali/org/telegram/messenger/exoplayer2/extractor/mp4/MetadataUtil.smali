...
.method private static parseCommentAttribute(ILorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;
    ...
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/Atom;->TYPE_data:I
    ...
    invoke-virtual {p1, v0}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readNullTerminatedString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v1}, Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static parseCoverArt(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/ApicFrame;
    ...
    new-instance v1, Lorg/telegram/messenger/exoplayer2/metadata/id3/ApicFrame;

    const/4 v4, 0x3

    invoke-direct {v1, v2, v0, v4, v3}, Lorg/telegram/messenger/exoplayer2/metadata/id3/ApicFrame;-><init>(Ljava/lang/String;Ljava/lang/String;I[B)V
...
.method public static parseIlstElement(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/Metadata$Entry;
    ...
    :try_start_0
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_COMMENT:I

    if-ne v2, v3, :cond_1

    invoke-static {v0, p0}, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->parseCommentAttribute(ILorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;
    :try_end_0
    ...
    :cond_1
    :try_start_1
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_NAME_1:I

    if-eq v2, v3, :cond_2

    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_NAME_2:I
    ...
    invoke-static {v0, v2, p0}, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->parseTextAttribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;
    :try_end_1
    ...
    :cond_3
    :try_start_2
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_COMPOSER_1:I

    if-eq v2, v3, :cond_4

    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_COMPOSER_2:I
    ...
    :cond_5
    :try_start_3
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_YEAR:I
    ...
    :cond_6
    :try_start_4
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_ARTIST:I
    ...
    :cond_7
    :try_start_5
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_ENCODER:I
    ...
    :cond_8
    :try_start_6
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_ALBUM:I
    ...
    :cond_9
    :try_start_7
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_LYRICS:I
    ...
    :cond_a
    :try_start_8
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->SHORT_TYPE_GENRE:I
    ...
    :cond_b
    :try_start_9
    sget v3, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_GROUPING:I
    ...
    :cond_c
    :try_start_a
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_GENRE:I
    ...
    :cond_d
    :try_start_b
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_DISK_NUMBER:I

    if-ne v0, v2, :cond_e

    const-string/jumbo v2, "TPOS"

    invoke-static {v0, v2, p0}, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->parseIndexAndCountAttribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;
    :try_end_b
    ...
    :cond_e
    :try_start_c
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_TRACK_NUMBER:I
    ...
    :cond_f
    :try_start_d
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_TEMPO:I
    ...
    invoke-static {v0, v2, p0, v3, v4}, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->parseUint8Attribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;ZZ)Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Frame;
    :try_end_d
    ...
    :cond_10
    :try_start_e
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_COMPILATION:I
    ...
    :cond_11
    :try_start_f
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_COVER_ART:I
    ...
    :cond_12
    :try_start_10
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_ALBUM_ARTIST:I
    ...
    :cond_13
    :try_start_11
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_SORT_TRACK_NAME:I
    ...
    :cond_14
    :try_start_12
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_SORT_ALBUM:I
    ...
    :cond_15
    :try_start_13
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_SORT_ARTIST:I
    ...
    :cond_16
    :try_start_14
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_SORT_ALBUM_ARTIST:I
    ...
    :cond_17
    :try_start_15
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_SORT_COMPOSER:I
    ...
    :cond_18
    :try_start_16
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_RATING:I
    ...
    :cond_19
    :try_start_17
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_GAPLESS_ALBUM:I
    ...
    :cond_1a
    :try_start_18
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_TV_SORT_SHOW:I
    ...
    :cond_1b
    :try_start_19
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_TV_SHOW:I
    ...
    :cond_1c
    :try_start_1a
    sget v2, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->TYPE_INTERNAL:I

    if-ne v0, v2, :cond_1d

    invoke-static {p0, v1}, Lorg/telegram/messenger/exoplayer2/extractor/mp4/MetadataUtil;->parseInternalAttribute(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;I)Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Frame;
    :try_end_1a
...
.method private static parseIndexAndCountAttribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    invoke-virtual {p2, v0}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->skipBytes(I)V
    ...
    invoke-direct {v1, p1, v0}, Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static parseInternalAttribute(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;I)Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Frame;
    ...
    sget v9, Lorg/telegram/messenger/exoplayer2/extractor/mp4/Atom;->TYPE_mean:I

    if-ne v8, v9, :cond_0

    add-int/lit8 v3, v6, -0xc

    invoke-virtual {p0, v3}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readNullTerminatedString(I)Ljava/lang/String;
    ...
    :cond_0
    sget v9, Lorg/telegram/messenger/exoplayer2/extractor/mp4/Atom;->TYPE_name:I

    if-ne v8, v9, :cond_1

    add-int/lit8 v2, v6, -0xc

    invoke-virtual {p0, v2}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readNullTerminatedString(I)Ljava/lang/String;
    ...
    :cond_1
    sget v9, Lorg/telegram/messenger/exoplayer2/extractor/mp4/Atom;->TYPE_data:I
    ...
    invoke-virtual {p0, v0}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readNullTerminatedString(I)Ljava/lang/String;

    move-result-object v0

    new-instance v5, Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;

    const-string/jumbo v1, "und"

    invoke-direct {v5, v1, v2, v0}, Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static parseStandardGenreAttribute(Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    invoke-direct {v0, v2, v1}, Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static parseTextAttribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;)Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    invoke-virtual {p2, v1}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->skipBytes(I)V

    add-int/lit8 v0, v0, -0x10

    invoke-virtual {p2, v0}, Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;->readNullTerminatedString(I)Ljava/lang/String;

    move-result-object v1

    new-instance v0, Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;

    invoke-direct {v0, p1, v1}, Lorg/telegram/messenger/exoplayer2/metadata/id3/TextInformationFrame;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static parseUint8Attribute(ILjava/lang/String;Lorg/telegram/messenger/exoplayer2/util/ParsableByteArray;ZZ)Lorg/telegram/messenger/exoplayer2/metadata/id3/Id3Frame;
    ...
    invoke-direct {v0, v2, p1, v1}, Lorg/telegram/messenger/exoplayer2/metadata/id3/CommentFrame;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
