...
.method public constructor <init>()V
    ...
    const-string/jumbo v0, "NotificationExtenderService"
...
.method static getIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    const-string/jumbo v2, "com.onesignal.NotificationExtender"
...
.method private processIntent(Landroid/content/Intent;)V
    ...
    const-string/jumbo v2, "No extras sent to NotificationExtenderService in its Intent!\n"
    ...
    :cond_1
    const-string/jumbo v1, "json_payload"
    ...
    const-string/jumbo v3, "json_payload key is nonexistent from bundle passed to NotificationExtenderService: "
    ...
    const-string/jumbo v1, "restoring"
    ...
    iput-boolean v1, p0, Lcom/onesignal/NotificationExtenderService;->currentlyRestoring:Z

    const-string/jumbo v1, "android_notif_id"
    ...
    iput-object v1, p0, Lcom/onesignal/NotificationExtenderService;->currentBaseOverrideSettings:Lcom/onesignal/NotificationExtenderService$OverrideSettings;

    iget-object v1, p0, Lcom/onesignal/NotificationExtenderService;->currentBaseOverrideSettings:Lcom/onesignal/NotificationExtenderService$OverrideSettings;

    const-string/jumbo v2, "android_notif_id"
    ...
    iput-object v0, p0, Lcom/onesignal/NotificationExtenderService;->restoreTimestamp:Ljava/lang/Long;

    iget-object v0, p0, Lcom/onesignal/NotificationExtenderService;->currentJsonPayload:Lorg/json/JSONObject;

    iget-boolean v1, p0, Lcom/onesignal/NotificationExtenderService;->currentlyRestoring:Z

    invoke-virtual {p0, v0, v1}, Lcom/onesignal/NotificationExtenderService;->processJsonObject(Lorg/json/JSONObject;Z)V
    :try_end_0
...
.method protected final displayNotification(Lcom/onesignal/NotificationExtenderService$OverrideSettings;)Lcom/onesignal/OSNotificationDisplayedResult;
    ...
    iput v0, v1, Lcom/onesignal/OSNotificationDisplayedResult;->androidNotificationId:I
...
.method processJsonObject(Lorg/json/JSONObject;Z)V
    ...
    iput-object v3, v0, Lcom/onesignal/OSNotificationReceivedResult;->payload:Lcom/onesignal/OSNotificationPayload;
    ...
    iput-boolean v3, v0, Lcom/onesignal/OSNotificationReceivedResult;->isAppInFocus:Z

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/onesignal/NotificationExtenderService;->osNotificationDisplayedResult:Lcom/onesignal/OSNotificationDisplayedResult;
    ...
    invoke-static {v0, v2}, Lcom/onesignal/NotificationBundleProcessor;->saveNotification(Lcom/onesignal/NotificationGenerationJob;Z)V
    ...
    const-string/jumbo v4, "onNotificationProcessing throw an exception. Displaying normal OneSignal notification."
    ...
    const-string/jumbo v4, "onNotificationProcessing throw an exception. Extended notification displayed but custom processing did not finish."
